...
type CollateralParams struct {
	...
	SlashFractionInvalid cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=slash_fraction_invalid,json=slashFractionInvalid,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_invalid"`
	// slash_fraction_downtime is the percentage of collateral to slash for downtime.
	SlashFractionDowntime cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=slash_fraction_downtime,json=slashFractionDowntime,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_downtime"`
	// downtime_missed_percentage_threshold is the missed request percentage that triggers a downtime slash.
	DowntimeMissedPercentageThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=downtime_missed_percentage_threshold,json=downtimeMissedPercentageThreshold,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"downtime_missed_percentage_threshold"`
	...
	BaseWeightRatio cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=base_weight_ratio,json=baseWeightRatio,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"base_weight_ratio"`
	// CollateralPerWeightUnit is the amount of collateral required per unit of weight
	CollateralPerWeightUnit cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=collateral_per_weight_unit,json=collateralPerWeightUnit,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"collateral_per_weight_unit"`
}
...
var fileDescriptor_3cf34332021bbe94 = []byte{
	...
	,
}
...
func (m *CollateralParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.CollateralPerWeightUnit.Size()
		i -= size
		if _, err := m.CollateralPerWeightUnit.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x32
	{
		size := m.BaseWeightRatio.Size()
		i -= size
		if _, err := m.BaseWeightRatio.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
	...
	{
		size := m.DowntimeMissedPercentageThreshold.Size()
		i -= size
		if _, err := m.DowntimeMissedPercentageThreshold.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
