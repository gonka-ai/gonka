...
var (
	...
	// Append-only pass_count records keyed by version name. Survives delete of
	// the matching approved-version row so a later re-approval cannot flip SPRT
	// scoring.
	DevshardVersionPoliciesPrefix = collections.NewPrefix(111)
