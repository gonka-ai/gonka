...
func (m *SettleAmount) GetRefundCoins() uint64 {
	if m != nil {
...
var fileDescriptor_b05d6309beaf448e = []byte{
	...
	,
}
...
func (m *SettleAmount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RefundCoins != 0 {
		i = encodeVarintSettleAmount(dAtA, i, uint64(m.RefundCoins))
		i--
		dAtA[i] = 0x18
	}
	if m.RewardCoins != 0 {
...
func (m *SettleAmount) Size() (n int) {
	...
	if m.RefundCoins != 0 {
		n += 1 + sovSettleAmount(uint64(m.RefundCoins))
	}
	if m.WorkCoins != 0 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RefundCoins |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
