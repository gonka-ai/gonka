...
func (msg *MsgSubmitTeeAttestation) GetSignersStrings() []string { return []string{msg.Creator} }
func (msg *MsgRevokeTeeAttestation) GetSignersStrings() []string { return []string{msg.Creator} }
func (msg *MsgSubmitTeeValidations) GetSignersStrings() []string { return []string{msg.Creator} }
