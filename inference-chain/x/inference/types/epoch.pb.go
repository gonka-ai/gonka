...
type Epoch struct {
	...
	EffectiveBlockHeight int64  `protobuf:"varint,3,opt,name=effective_block_height,json=effectiveBlockHeight,proto3" json:"effective_block_height,omitempty"`
}
...
func (m *Epoch) GetEffectiveBlockHeight() int64 {
	if m != nil {
...
var fileDescriptor_c4155d4ad4931767 = []byte{
	...
	,
}
...
func (m *Epoch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EffectiveBlockHeight != 0 {
		i = encodeVarintEpoch(dAtA, i, uint64(m.EffectiveBlockHeight))
		i--
		dAtA[i] = 0x18
	}
...
func (m *Epoch) Size() (n int) {
	...
	if m.EffectiveBlockHeight != 0 {
		n += 1 + sovEpoch(uint64(m.EffectiveBlockHeight))
	}
	return n
}
