...
var (
	...
	pattern_Query_CountPoCvalidationsAtHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"productscience", "inference", "v1", "count_po_c_validations_at_height", "block_height"}, "", runtime.AssumeColonVerbOpt(false)))
)
