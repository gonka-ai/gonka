...
var (
	...
	ErrTeeAttestationDisabled                = sdkerrors.Register(ModuleName, 1177, "TEE attestation submissions are disabled by params")
	ErrTeeAttestationProviderNotAllowed      = sdkerrors.Register(ModuleName, 1178, "TEE attestation provider is not in the allowed list")
	ErrTeeAttestationEnvelopeNotAllowed      = sdkerrors.Register(ModuleName, 1179, "TEE attestation envelope version is not in the allowed list")
	ErrTeeAttestationInvalidPublicKey        = sdkerrors.Register(ModuleName, 1180, "TEE attestation public key must be 32 raw bytes (X25519)")
	ErrTeeAttestationQuoteRequired           = sdkerrors.Register(ModuleName, 1181, "TEE attestation quote_hash is required but missing")
	ErrTeeAttestationNodeIdEmpty             = sdkerrors.Register(ModuleName, 1182, "TEE attestation node_id is empty")
	ErrTeeAttestationNotFound                = sdkerrors.Register(ModuleName, 1183, "TEE attestation not found")
	ErrTeeAttestationMeasurementNotAllowed   = sdkerrors.Register(ModuleName, 1184, "TEE attestation measurement is not in the allowed list")
	ErrTeeAttestationQuoteTooLarge           = sdkerrors.Register(ModuleName, 1185, "TEE attestation quote exceeds max bytes")
	ErrTeeValidationOutsideWindow            = sdkerrors.Register(ModuleName, 1187, "TEE validation outside of accepted window")
	ErrTeeValidationSubjectUnknown           = sdkerrors.Register(ModuleName, 1188, "TEE validation references an unknown subject address")
	ErrTeeValidationVerdictUnspecified       = sdkerrors.Register(ModuleName, 1189, "TEE validation verdict must be OK or REJECT")
	ErrTeeValidationAlreadyExists            = sdkerrors.Register(ModuleName, 1190, "TEE validation already exists for this attestation from this validator")
)
