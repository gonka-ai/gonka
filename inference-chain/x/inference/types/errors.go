...
var (
	...
	ErrContinuousPoCDisabled                 = sdkerrors.Register(ModuleName, 1170, "continuous PoC is not enabled")
	ErrContinuousPoCMaxCommitsExceeded       = sdkerrors.Register(ModuleName, 1171, "maximum continuous PoC commits per epoch exceeded")
	ErrContinuousPoCMinNoncesNotMet          = sdkerrors.Register(ModuleName, 1172, "nonce count below minimum per commit")
	ErrContinuousPoCInvalidUtilization       = sdkerrors.Register(ModuleName, 1173, "GPU utilization basis points must be in [0, 10000]")
	ErrContinuousPoCChallengeNotFound        = sdkerrors.Register(ModuleName, 1174, "continuous PoC challenge not found")
	ErrContinuousPoCChallengeExpired         = sdkerrors.Register(ModuleName, 1175, "continuous PoC challenge has expired")
	ErrContinuousPoCInvalidMerkleProof       = sdkerrors.Register(ModuleName, 1176, "continuous PoC Merkle proof is invalid")
	ErrCacheQualityDisabled                  = sdkerrors.Register(ModuleName, 1177, "semantic cache quality feature is not enabled")
	ErrCacheQualityInvalidSimilarity         = sdkerrors.Register(ModuleName, 1178, "avg_similarity_bps must be in [0, 10000]")
	ErrCacheQualityInvalidCount              = sdkerrors.Register(ModuleName, 1179, "cache count values must be non-negative")
	ErrCacheQualitySummaryAlreadyExists      = sdkerrors.Register(ModuleName, 1180, "cache quality summary already submitted for this epoch")
	ErrCacheQualityModelVersionMismatch      = sdkerrors.Register(ModuleName, 1181, "embedding_model_version in summary does not match governance-managed EmbeddingModelVersion in CacheQualityParams")
)
