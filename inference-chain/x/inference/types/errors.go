...
var (
	...
	ErrEpochNotFound                           = sdkerrors.Register(ModuleName, 1127, "epoch not found")
	ErrIllegalState                            = sdkerrors.Register(ModuleName, 1134, "illegal state for the operation requested")
)
