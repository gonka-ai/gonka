...
var (
	...
	ErrInvalidVoteCount                      = sdkerrors.Register(ModuleName, 1171, "invalid vote count")
	ErrDuplicatePositiveVote                 = sdkerrors.Register(ModuleName, 1172, "more than one positive vote")
	ErrNegativeVoteAfterPositive             = sdkerrors.Register(ModuleName, 1173, "negative vote after positive vote")
	ErrInvalidVoteType                       = sdkerrors.Register(ModuleName, 1174, "invalid vote type")
	ErrInvalidVotingResultSignature          = sdkerrors.Register(ModuleName, 1175, "invalid voting result signature")
