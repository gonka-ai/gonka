...
var (
	...
	ErrContinuousPoCChallengeNotFound        = sdkerrors.Register(ModuleName, 1170, "continuous PoC challenge not found")
	ErrContinuousPoCChallengeExpired         = sdkerrors.Register(ModuleName, 1171, "continuous PoC challenge has expired")
	ErrContinuousPoCInvalidMerkleProof       = sdkerrors.Register(ModuleName, 1172, "continuous PoC Merkle proof is invalid")
)
