...
var (
	...
	ErrMaintenanceNotImplemented             = sdkerrors.Register(ModuleName, 1174, "maintenance feature not yet implemented")
	ErrMaintenanceDisabled                   = sdkerrors.Register(ModuleName, 1175, "maintenance windows are disabled")
	ErrMaintenanceInsufficientCredit         = sdkerrors.Register(ModuleName, 1176, "insufficient maintenance credit")
	ErrMaintenanceInsufficientLeadTime       = sdkerrors.Register(ModuleName, 1177, "start height does not satisfy minimum scheduling lead time")
	ErrMaintenanceDurationExceeded           = sdkerrors.Register(ModuleName, 1178, "duration exceeds maximum maintenance window blocks")
	ErrMaintenanceConcurrentCountExceeded    = sdkerrors.Register(ModuleName, 1179, "concurrent maintenance participant count cap exceeded")
	ErrMaintenanceConcurrentPowerExceeded    = sdkerrors.Register(ModuleName, 1180, "concurrent maintenance power cap exceeded")
	ErrMaintenanceOverlap                    = sdkerrors.Register(ModuleName, 1181, "maintenance window overlaps existing reservation for this participant")
	ErrMaintenanceAlreadyScheduled           = sdkerrors.Register(ModuleName, 1182, "participant already has a scheduled maintenance window")
	ErrMaintenanceReservationNotFound        = sdkerrors.Register(ModuleName, 1183, "maintenance reservation not found")
	ErrMaintenanceNotScheduled               = sdkerrors.Register(ModuleName, 1184, "reservation is not in scheduled state")
	ErrMaintenanceOverlapsPoCPhase           = sdkerrors.Register(ModuleName, 1185, "maintenance window overlaps PoC commit/exchange phase")
	ErrMaintenanceOverlapsDKGPhase           = sdkerrors.Register(ModuleName, 1186, "maintenance window overlaps DKG phase")
)
