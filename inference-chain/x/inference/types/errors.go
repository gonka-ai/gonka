...
var (
	...
	ErrTrainingTaskNotFound                    = sdkerrors.Register(ModuleName, 1119, "training task not found")
	ErrTrainingTaskAlreadyClaimedForAssignment = sdkerrors.Register(ModuleName, 1120, "training task already claimed for assignment")
	ErrTrainingTaskAlreadyAssigned             = sdkerrors.Register(ModuleName, 1121, "training task already assigned")
)
