...
var (
	...
	ErrEpochNotFound                           = sdkerrors.Register(ModuleName, 1134, "epoch not found")
	ErrIllegalState                            = sdkerrors.Register(ModuleName, 1135, "illegal state for the operation requested")
)
