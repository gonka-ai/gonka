...
var (
	...
	ErrPoCChallengePaymentZero               = sdkerrors.Register(ModuleName, 1203, "PoC challenge locked payment is zero")
	ErrPoCChallengeWindow                    = sdkerrors.Register(ModuleName, 1204, "PoC challenge cannot be created in this window")
	ErrPoCChallengeGenerating                = sdkerrors.Register(ModuleName, 1205, "participant is generating a PoC challenge")
)
