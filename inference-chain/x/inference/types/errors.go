...
var (
	...
	ErrTrainingDisabled                      = sdkerrors.Register(ModuleName, 1193, "training feature is disabled")
	ErrTrainshardProposalNotFound            = sdkerrors.Register(ModuleName, 1194, "training proposal not found")
	ErrTrainshardProposalNotOpen             = sdkerrors.Register(ModuleName, 1195, "training proposal is not open")
	ErrTrainshardProfileNotAllowed           = sdkerrors.Register(ModuleName, 1196, "gpu profile is not allowed for training")
	ErrTrainshardProposalLimits              = sdkerrors.Register(ModuleName, 1197, "training proposal violates static caps")
	ErrTrainshardCapacity                    = sdkerrors.Register(ModuleName, 1198, "insufficient free training capacity for request")
	ErrTrainshardNotFound                    = sdkerrors.Register(ModuleName, 1199, "trainshard not found")
	ErrTrainshardNotCreator                  = sdkerrors.Register(ModuleName, 1200, "only the shard creator may settle it")
	ErrTrainshardCooldown                    = sdkerrors.Register(ModuleName, 1201, "creator is within training cooldown window")
	ErrTrainshardActiveLimit                 = sdkerrors.Register(ModuleName, 1202, "active shard limit reached")
	ErrTrainshardNodeReserved                = sdkerrors.Register(ModuleName, 1203, "node is reserved by an active trainshard")
	ErrTrainshardNodeNotOwned                = sdkerrors.Register(ModuleName, 1204, "node is not owned by the host")
	ErrTrainshardProfileEmpty                = sdkerrors.Register(ModuleName, 1205, "gpu profile id must not be empty")
	ErrTrainshardNotActive                   = sdkerrors.Register(ModuleName, 1206, "trainshard is not active")
	ErrTrainshardNodeNotActive               = sdkerrors.Register(ModuleName, 1207, "node is not an active node of the trainshard")
	ErrTrainshardAutokickNotAllowed          = sdkerrors.Register(ModuleName, 1208, "signer may not autokick nodes of this trainshard")
	ErrTrainshardBaseImageInvalid            = sdkerrors.Register(ModuleName, 1209, "base image must be pinned as repository@sha256:<digest>")
	ErrTrainshardOptInRequest                = sdkerrors.Register(ModuleName, 1210, "invalid training opt-in request")
)
