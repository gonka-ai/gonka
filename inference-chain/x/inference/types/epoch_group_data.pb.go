...
type EpochGroupData struct {
	...
	// List of sub EpochGroups, only used in parent EpochGroup
	SubGroupHeights []uint64 `protobuf:"varint,15,rep,packed,name=sub_group_heights,json=subGroupHeights,proto3" json:"sub_group_heights,omitempty"`
}
...
func (m *EpochGroupData) GetSubGroupHeights() []uint64 {
	if m != nil {
		return m.SubGroupHeights
	}
	return nil
}
...
var fileDescriptor_47040406f6377eb3 = []byte{
	...
	,
}
...
func (m *EpochGroupData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SubGroupHeights) > 0 {
		dAtA2 := make([]byte, len(m.SubGroupHeights)*10)
		var j1 int
		for _, num := range m.SubGroupHeights {
			for num >= 1<<7 {
		...
		i = encodeVarintEpochGroupData(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0x7a
	}
	if len(m.ModelId) > 0 {
...
func (m *EpochGroupData) Size() (n int) {
	...
	if len(m.SubGroupHeights) > 0 {
		l = 0
		for _, e := range m.SubGroupHeights {
			l += sovEpochGroupData(uint64(e))
		}
		n += 1 + sovEpochGroupData(uint64(l)) + l
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 15:
			if wireType == 0 {
				...
				m.SubGroupHeights = append(m.SubGroupHeights, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SubGroupHeights) == 0 {
					m.SubGroupHeights = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SubGroupHeights", wireType)
			}
		default:
			iNdEx = preIndex
