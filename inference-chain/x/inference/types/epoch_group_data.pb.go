...
type EpochGroupData struct {
	...
	// When true, ConfirmationWeightScale.has_trusted_voting_power is meaningful,
	// including the all-false case (every accounting model currently has zero
	// trusted voting power). When false, legacy epochs treat every scale as trusted.
	ConfirmationAccountingSeparated bool `protobuf:"varint,20,opt,name=confirmation_accounting_separated,json=confirmationAccountingSeparated,proto3" json:"confirmation_accounting_separated,omitempty"`
}
...
func (m *EpochGroupData) GetConfirmationAccountingSeparated() bool {
	if m != nil {
		return m.ConfirmationAccountingSeparated
	}
	return false
}
...
type ConfirmationWeightScale struct {
	...
	// has_trusted_voting_power is only consulted when the parent EpochGroupData
	// has confirmation_accounting_separated = true. False means the model still
	// belongs in the accounting denominator, but it has no trusted cPoC voters.
	HasTrustedVotingPower bool `protobuf:"varint,3,opt,name=has_trusted_voting_power,json=hasTrustedVotingPower,proto3" json:"has_trusted_voting_power,omitempty"`
}
...
func (m *ConfirmationWeightScale) GetHasTrustedVotingPower() bool {
	if m != nil {
		return m.HasTrustedVotingPower
	}
	return false
}
...
var fileDescriptor_47040406f6377eb3 = []byte{
	...
	,
}
...
func (m *EpochGroupData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ConfirmationAccountingSeparated {
		i--
		if m.ConfirmationAccountingSeparated {
			dAtA[i] = 1
		} else {
...
func (m *EpochGroupData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConfirmationAccountingSeparated", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConfirmationAccountingSeparated = bool(v != 0)
		default:
			iNdEx = preIndex
...
func (m *ConfirmationWeightScale) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasTrustedVotingPower", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HasTrustedVotingPower = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipEpochGroupData(dAtA[iNdEx:])
			if err != nil {
