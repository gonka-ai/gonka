...
func (m *EpochGroupData) GetModelEpochGroups() []*ModelEpochGroup {
	if m != nil {
		return m.ModelEpochGroups
	}
	return nil
}
...
func (m *ModelEpochGroup) Reset()         { *m = ModelEpochGroup{} }
func (m *ModelEpochGroup) String() string { return proto.CompactTextString(m) }
func (*ModelEpochGroup) ProtoMessage()    {}
func (*ModelEpochGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_47040406f6377eb3, []int{1}
}
func (m *ModelEpochGroup) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ModelEpochGroup) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ModelEpochGroup.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ModelEpochGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModelEpochGroup.Merge(m, src)
}
func (m *ModelEpochGroup) XXX_Size() int {
	return m.Size()
}
func (m *ModelEpochGroup) XXX_DiscardUnknown() {
	xxx_messageInfo_ModelEpochGroup.DiscardUnknown(m)
}

var xxx_messageInfo_ModelEpochGroup proto.InternalMessageInfo

func (m *ModelEpochGroup) GetModelId() string {
	if m != nil {
		return m.ModelId
	}
	return ""
...
func (m *ModelEpochGroup) GetEpochGroupId() uint64 {
	if m != nil {
		return m.EpochGroupId
	}
	return 0
...
func (m *ModelEpochGroup) GetEpochPolicy() string {
	if m != nil {
		return m.EpochPolicy
	}
	return ""
...
func (m *ModelEpochGroup) GetValidationWeights() []*ValidationWeight {
	if m != nil {
		return m.ValidationWeights
	}
	return nil
...
func (m *ModelEpochGroup) GetTotalWeight() int64 {
	if m != nil {
		return m.TotalWeight
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ModelEpochGroup)(nil), "inference.inference.ModelEpochGroup")
...
var fileDescriptor_47040406f6377eb3 = []byte{
	...
	,
}
...
func (m *EpochGroupData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ModelEpochGroups) > 0 {
		for iNdEx := len(m.ModelEpochGroups) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ModelEpochGroups[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ModelEpochGroup) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ModelEpochGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModelEpochGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EpochGroupData) Size() (n int) {
	...
	if len(m.ModelEpochGroups) > 0 {
		for _, e := range m.ModelEpochGroups {
			l = e.Size()
			n += 1 + l + sovEpochGroupData(uint64(l))
		}
	}
...
func (m *ModelEpochGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EpochGroupData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ModelEpochGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ModelEpochGroups = append(m.ModelEpochGroups, &ModelEpochGroup{})
			if err := m.ModelEpochGroups[len(m.ModelEpochGroups)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ModelEpochGroup) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ModelEpochGroup: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ModelEpochGroup: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
