...
func (k Keeper) InitiateKeyGenerationForEpoch(ctx sdk.Context, epochID uint64, finalizedParticipants []ParticipantWithWeightAndKey) error {
...
func (k Keeper) AssignSlots(participants []ParticipantWithWeightAndKey, totalSlots uint32) ([]types.BLSParticipantInfo, error) {
