...
import (
	...
	"github.com/productscience/inference/app/upgrades/v1_7"
...
func (app *App) setupUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(v1_7.UpgradeName, v1_7.CreateUpgradeHandler(app.ModuleManager, app.Configurator()))
}
