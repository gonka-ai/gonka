...
func BenchmarkSimulation(b *testing.B) {
	...
	bApp, err := app.New(logger, db, nil, true, appOptions, emptyWasmOpts, fauxMerkleModeOpt, baseapp.SetChainID(SimAppChainID), fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp, err := app.New(logger, newDB, nil, true, appOptions, emptyWasmOpts, fauxMerkleModeOpt, baseapp.SetChainID(SimAppChainID), fauxMerkleModeOpt)
	require.NoError(t, err)
