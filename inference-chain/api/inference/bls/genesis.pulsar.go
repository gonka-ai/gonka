...
var (
	...
	fd_GenesisState_active_epoch_index protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_active_epoch_index = md_GenesisState.Fields().ByName("active_epoch_index")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ActiveEpochIndex != uint64(0) {
		value := protoreflect.ValueOfUint64(x.ActiveEpochIndex)
		if !f(fd_GenesisState_active_epoch_index, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.bls.GenesisState.params":
		return x.Params != nil
	case "inference.bls.GenesisState.active_epoch_index":
		return x.ActiveEpochIndex != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.bls.GenesisState.active_epoch_index":
		panic(fmt.Errorf("field active_epoch_index of message inference.bls.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.bls.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.ActiveEpochIndex != 0 {
			n += 1 + runtime.Sov(uint64(x.ActiveEpochIndex))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ActiveEpochIndex != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.ActiveEpochIndex))
			i--
			dAtA[i] = 0x10
		}
		if x.Params != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ActiveEpochIndex", wireType)
				}
				x.ActiveEpochIndex = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.ActiveEpochIndex |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type GenesisState struct {
	...
	// active_epoch_index is the current epoch undergoing DKG process
	// Only one epoch can have active DKG at a time
	// 0 means no active DKG
	ActiveEpochIndex uint64 `protobuf:"varint,2,opt,name=active_epoch_index,json=activeEpochIndex,proto3" json:"active_epoch_index,omitempty"`
}
...
func (x *GenesisState) GetActiveEpochIndex() uint64 {
	if x != nil {
		return x.ActiveEpochIndex
	}
	return 0
}
...
var file_inference_bls_genesis_proto_rawDesc = []byte{
	...
	0xb0, 0x2a, 0x01, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x61,
	0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x69, 0x6e, 0x64, 0x65,
	0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x45,
	0x70, 0x6f, 0x63, 0x68, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42, 0x96, 0x01, 0x0a, 0x11, 0x63, 0x6f,
