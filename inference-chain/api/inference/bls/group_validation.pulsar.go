...
var (
	...
	fd_GroupKeyValidationState_new_epoch_index      protoreflect.FieldDescriptor
	fd_GroupKeyValidationState_previous_epoch_index protoreflect.FieldDescriptor
...
func init() {
	...
	fd_GroupKeyValidationState_new_epoch_index = md_GroupKeyValidationState.Fields().ByName("new_epoch_index")
	fd_GroupKeyValidationState_previous_epoch_index = md_GroupKeyValidationState.Fields().ByName("previous_epoch_index")
...
func (x *fastReflection_GroupKeyValidationState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.NewEpochIndex != uint64(0) {
		...
		if !f(fd_GroupKeyValidationState_new_epoch_index, value) {
			return
		}
	}
	if x.PreviousEpochIndex != uint64(0) {
		value := protoreflect.ValueOfUint64(x.PreviousEpochIndex)
		if !f(fd_GroupKeyValidationState_previous_epoch_index, value) {
			return
		}
	}
	if x.Status != 0 {
...
func (x *fastReflection_GroupKeyValidationState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.bls.GroupKeyValidationState.new_epoch_index":
		return x.NewEpochIndex != uint64(0)
	case "inference.bls.GroupKeyValidationState.previous_epoch_index":
		return x.PreviousEpochIndex != uint64(0)
...
func (x *fastReflection_GroupKeyValidationState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.bls.GroupKeyValidationState.previous_epoch_index":
		x.PreviousEpochIndex = value.Uint()
	case "inference.bls.GroupKeyValidationState.status":
...
func (x *fastReflection_GroupKeyValidationState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.bls.GroupKeyValidationState.new_epoch_index":
		panic(fmt.Errorf("field new_epoch_index of message inference.bls.GroupKeyValidationState is not mutable"))
	case "inference.bls.GroupKeyValidationState.previous_epoch_index":
		panic(fmt.Errorf("field previous_epoch_index of message inference.bls.GroupKeyValidationState is not mutable"))
	case "inference.bls.GroupKeyValidationState.status":
...
func (x *fastReflection_GroupKeyValidationState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.PreviousEpochIndex != 0 {
			n += 1 + runtime.Sov(uint64(x.PreviousEpochIndex))
		}
		if x.Status != 0 {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.PreviousEpochIndex != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.PreviousEpochIndex))
			i--
			dAtA[i] = 0x10
		}
		if x.NewEpochIndex != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PreviousEpochIndex", wireType)
				}
				x.PreviousEpochIndex = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.PreviousEpochIndex |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *GroupKeyValidationState) GetNewEpochIndex() uint64 {
	if x != nil {
...
func (x *GroupKeyValidationState) GetPreviousEpochIndex() uint64 {
	if x != nil {
		return x.PreviousEpochIndex
	}
	return 0
}
...
var file_inference_bls_group_validation_proto_rawDesc = []byte{
	...
	,
	...
	,
