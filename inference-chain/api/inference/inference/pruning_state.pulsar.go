...
var (
	...
	fd_PruningState_preserved_nodes_snapshots_pruned_epoch   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PruningState_preserved_nodes_snapshots_pruned_epoch = md_PruningState.Fields().ByName("preserved_nodes_snapshots_pruned_epoch")
}
...
func (x *fastReflection_PruningState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PreservedNodesSnapshotsPrunedEpoch != int64(0) {
		value := protoreflect.ValueOfInt64(x.PreservedNodesSnapshotsPrunedEpoch)
		if !f(fd_PruningState_preserved_nodes_snapshots_pruned_epoch, value) {
			return
		}
	}
}
...
func (x *fastReflection_PruningState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.PruningState.preserved_nodes_snapshots_pruned_epoch":
		return x.PreservedNodesSnapshotsPrunedEpoch != int64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_PruningState) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "inference.inference.PruningState.preserved_nodes_snapshots_pruned_epoch":
		x.PreservedNodesSnapshotsPrunedEpoch = int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.PruningState"))
		}
...
func (x *fastReflection_PruningState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.PruningState.poc_validation_snapshots_pruned_epoch":
		...
		return protoreflect.ValueOfInt64(value)
	case "inference.inference.PruningState.preserved_nodes_snapshots_pruned_epoch":
		value := x.PreservedNodesSnapshotsPrunedEpoch
		return protoreflect.ValueOfInt64(value)
	default:
...
func (x *fastReflection_PruningState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.PruningState.preserved_nodes_snapshots_pruned_epoch":
		x.PreservedNodesSnapshotsPrunedEpoch = value.Int()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.PruningState"))
		}
...
func (x *fastReflection_PruningState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.PruningState.preserved_nodes_snapshots_pruned_epoch":
		panic(fmt.Errorf("field preserved_nodes_snapshots_pruned_epoch of message inference.inference.PruningState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.PruningState"))
		}
...
func (x *fastReflection_PruningState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.PreservedNodesSnapshotsPrunedEpoch != 0 {
			n += 1 + runtime.Sov(uint64(x.PreservedNodesSnapshotsPrunedEpoch))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.PreservedNodesSnapshotsPrunedEpoch != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.PreservedNodesSnapshotsPrunedEpoch))
			i--
			dAtA[i] = 0x50
		}
		if x.PocValidationSnapshotsPrunedEpoch != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 10:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PreservedNodesSnapshotsPrunedEpoch", wireType)
				}
				x.PreservedNodesSnapshotsPrunedEpoch = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.PreservedNodesSnapshotsPrunedEpoch |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *PruningState) GetPreservedNodesSnapshotsPrunedEpoch() int64 {
	if x != nil {
		return x.PreservedNodesSnapshotsPrunedEpoch
	}
	return 0
}
...
var file_inference_inference_pruning_state_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0xe4,
	...
	,
