...
var _ protoreflect.List = (*_ProofOps_2_list)(nil)

type _ProofOps_2_list struct {
	list *[]*ProofOp
}

func (x *_ProofOps_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ProofOps_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ProofOps_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ProofOp)
	(*x.list)[i] = concreteValue
}

func (x *_ProofOps_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ProofOp)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ProofOps_2_list) AppendMutable() protoreflect.Value {
	v := new(ProofOp)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProofOps_2_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ProofOps_2_list) NewElement() protoreflect.Value {
	v := new(ProofOp)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProofOps_2_list) IsValid() bool {
	return x.list != nil
}
...
func (x *fastReflection_ProofOps) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Ops) != 0 {
		value := protoreflect.ValueOfList(&_ProofOps_2_list{list: &x.Ops})
...
func (x *fastReflection_ProofOps) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ProofOps.ops":
		if len(x.Ops) == 0 {
			return protoreflect.ValueOfList(&_ProofOps_2_list{})
		}
		listValue := &_ProofOps_2_list{list: &x.Ops}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ProofOps"))
...
func (x *fastReflection_ProofOps) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ProofOps.ops":
		...
		value := &_ProofOps_2_list{list: &x.Ops}
		return protoreflect.ValueOfList(value)
	case "inference.inference.ProofOps.block_height":
...
func (x *fastReflection_ProofOps) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ProofOps.ops":
		list := []*ProofOp{}
		return protoreflect.ValueOfList(&_ProofOps_2_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ProofOps"))
		}
...
type ProofOps struct {
	...
	BlockHeight int64      `protobuf:"varint,1,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
	Ops         []*ProofOp `protobuf:"bytes,2,rep,name=ops,proto3" json:"ops,omitempty"`
}
...
var file_inference_inference_block_proof_proto_rawDesc = []byte{
	...
	0x6f, 0x52, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22, 0x43, 0x0a,
	...
	0x74, 0x61, 0x22, 0x63, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x70, 0x73, 0x12, 0x21,
	...
	0x74, 0x12, 0x34, 0x0a, 0x03, 0x6f, 0x70, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c,
	0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x70, 0x42, 0x04, 0xc8, 0xde,
	0x1f, 0x00, 0x52, 0x03, 0x6f, 0x70, 0x73, 0x42, 0xcd, 0x01, 0xc8, 0xe2, 0x1e, 0x01, 0xd0, 0xe2,
	0x1e, 0x01, 0xd8, 0xe2, 0x1e, 0x01, 0xe0, 0xe2, 0x1e, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e,
	0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x42, 0x0f, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x50,
