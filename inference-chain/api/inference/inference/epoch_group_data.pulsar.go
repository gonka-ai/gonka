...
var _ protoreflect.List = (*_EpochGroupData_14_list)(nil)

type _EpochGroupData_14_list struct {
	list *[]*ModelEpochGroup
}

func (x *_EpochGroupData_14_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_EpochGroupData_14_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_EpochGroupData_14_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ModelEpochGroup)
	(*x.list)[i] = concreteValue
}

func (x *_EpochGroupData_14_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ModelEpochGroup)
	*x.list = append(*x.list, concreteValue)
}

func (x *_EpochGroupData_14_list) AppendMutable() protoreflect.Value {
	v := new(ModelEpochGroup)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EpochGroupData_14_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_EpochGroupData_14_list) NewElement() protoreflect.Value {
	v := new(ModelEpochGroup)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EpochGroupData_14_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_EpochGroupData_model_epoch_groups      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EpochGroupData_model_epoch_groups = md_EpochGroupData.Fields().ByName("model_epoch_groups")
}
...
func (x *fastReflection_EpochGroupData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ModelEpochGroups) != 0 {
		value := protoreflect.ValueOfList(&_EpochGroupData_14_list{list: &x.ModelEpochGroups})
		if !f(fd_EpochGroupData_model_epoch_groups, value) {
			return
		}
	}
}
...
func (x *fastReflection_EpochGroupData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.EpochGroupData.model_epoch_groups":
		return len(x.ModelEpochGroups) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EpochGroupData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupData.model_epoch_groups":
		if len(x.ModelEpochGroups) == 0 {
			return protoreflect.ValueOfList(&_EpochGroupData_14_list{})
		}
		listValue := &_EpochGroupData_14_list{list: &x.ModelEpochGroups}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_EpochGroupData) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.EpochGroupData.model_epoch_groups":
		lv := value.List()
		clv := lv.(*_EpochGroupData_14_list)
		x.ModelEpochGroups = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.EpochGroupData"))
		}
...
func (x *fastReflection_EpochGroupData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupData.model_epoch_groups":
		if x.ModelEpochGroups == nil {
			x.ModelEpochGroups = []*ModelEpochGroup{}
		}
		value := &_EpochGroupData_14_list{list: &x.ModelEpochGroups}
		return protoreflect.ValueOfList(value)
	case "inference.inference.EpochGroupData.poc_start_block_height":
...
func (x *fastReflection_EpochGroupData) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupData.model_epoch_groups":
		list := []*ModelEpochGroup{}
		return protoreflect.ValueOfList(&_EpochGroupData_14_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.EpochGroupData"))
		}
...
func (x *fastReflection_EpochGroupData) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ModelEpochGroups) > 0 {
			for _, e := range x.ModelEpochGroups {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ModelEpochGroups) > 0 {
			for iNdEx := len(x.ModelEpochGroups) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.ModelEpochGroups[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 14:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ModelEpochGroups", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ModelEpochGroups = append(x.ModelEpochGroups, &ModelEpochGroup{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ModelEpochGroups[len(x.ModelEpochGroups)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var _ protoreflect.List = (*_ModelEpochGroup_4_list)(nil)

type _ModelEpochGroup_4_list struct {
	list *[]*ValidationWeight
}

func (x *_ModelEpochGroup_4_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ModelEpochGroup_4_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ModelEpochGroup_4_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ValidationWeight)
	(*x.list)[i] = concreteValue
}

func (x *_ModelEpochGroup_4_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ValidationWeight)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ModelEpochGroup_4_list) AppendMutable() protoreflect.Value {
	v := new(ValidationWeight)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ModelEpochGroup_4_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ModelEpochGroup_4_list) NewElement() protoreflect.Value {
	v := new(ValidationWeight)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ModelEpochGroup_4_list) IsValid() bool {
	return x.list != nil
}

var (
	md_ModelEpochGroup                    protoreflect.MessageDescriptor
	fd_ModelEpochGroup_model_id           protoreflect.FieldDescriptor
	fd_ModelEpochGroup_epoch_group_id     protoreflect.FieldDescriptor
	fd_ModelEpochGroup_epoch_policy       protoreflect.FieldDescriptor
	fd_ModelEpochGroup_validation_weights protoreflect.FieldDescriptor
	fd_ModelEpochGroup_total_weight       protoreflect.FieldDescriptor
)

func init() {
	file_inference_inference_epoch_group_data_proto_init()
	md_ModelEpochGroup = File_inference_inference_epoch_group_data_proto.Messages().ByName("ModelEpochGroup")
	fd_ModelEpochGroup_model_id = md_ModelEpochGroup.Fields().ByName("model_id")
	fd_ModelEpochGroup_epoch_group_id = md_ModelEpochGroup.Fields().ByName("epoch_group_id")
	fd_ModelEpochGroup_epoch_policy = md_ModelEpochGroup.Fields().ByName("epoch_policy")
	fd_ModelEpochGroup_validation_weights = md_ModelEpochGroup.Fields().ByName("validation_weights")
	fd_ModelEpochGroup_total_weight = md_ModelEpochGroup.Fields().ByName("total_weight")
}

var _ protoreflect.Message = (*fastReflection_ModelEpochGroup)(nil)

type fastReflection_ModelEpochGroup ModelEpochGroup

func (x *ModelEpochGroup) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ModelEpochGroup)(x)
}

func (x *ModelEpochGroup) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ModelEpochGroup_messageType fastReflection_ModelEpochGroup_messageType
var _ protoreflect.MessageType = fastReflection_ModelEpochGroup_messageType{}

type fastReflection_ModelEpochGroup_messageType struct{}

func (x fastReflection_ModelEpochGroup_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ModelEpochGroup)(nil)
}
func (x fastReflection_ModelEpochGroup_messageType) New() protoreflect.Message {
	return new(fastReflection_ModelEpochGroup)
}
func (x fastReflection_ModelEpochGroup_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ModelEpochGroup
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ModelEpochGroup) Descriptor() protoreflect.MessageDescriptor {
	return md_ModelEpochGroup
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ModelEpochGroup) Type() protoreflect.MessageType {
	return _fastReflection_ModelEpochGroup_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ModelEpochGroup) New() protoreflect.Message {
	return new(fastReflection_ModelEpochGroup)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ModelEpochGroup) Interface() protoreflect.ProtoMessage {
	return (*ModelEpochGroup)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ModelEpochGroup) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ModelId != "" {
		value := protoreflect.ValueOfString(x.ModelId)
		if !f(fd_ModelEpochGroup_model_id, value) {
			return
		}
	}
	if x.EpochGroupId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.EpochGroupId)
		if !f(fd_ModelEpochGroup_epoch_group_id, value) {
			return
		}
	}
	if x.EpochPolicy != "" {
		value := protoreflect.ValueOfString(x.EpochPolicy)
		if !f(fd_ModelEpochGroup_epoch_policy, value) {
			return
		}
	}
	if len(x.ValidationWeights) != 0 {
		value := protoreflect.ValueOfList(&_ModelEpochGroup_4_list{list: &x.ValidationWeights})
		if !f(fd_ModelEpochGroup_validation_weights, value) {
			return
		}
	}
	if x.TotalWeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.TotalWeight)
		if !f(fd_ModelEpochGroup_total_weight, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ModelEpochGroup) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.inference.ModelEpochGroup.model_id":
		return x.ModelId != ""
	case "inference.inference.ModelEpochGroup.epoch_group_id":
		return x.EpochGroupId != uint64(0)
	case "inference.inference.ModelEpochGroup.epoch_policy":
		return x.EpochPolicy != ""
	case "inference.inference.ModelEpochGroup.validation_weights":
		return len(x.ValidationWeights) != 0
	case "inference.inference.ModelEpochGroup.total_weight":
		return x.TotalWeight != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ModelEpochGroup"))
		}
		panic(fmt.Errorf("message inference.inference.ModelEpochGroup does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ModelEpochGroup) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "inference.inference.ModelEpochGroup.model_id":
		x.ModelId = ""
	case "inference.inference.ModelEpochGroup.epoch_group_id":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ModelEpochGroup) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "inference.inference.ModelEpochGroup.model_id":
		value := x.ModelId
		return protoreflect.ValueOfString(value)
	...
	case "inference.inference.ModelEpochGroup.validation_weights":
		if len(x.ValidationWeights) == 0 {
			return protoreflect.ValueOfList(&_ModelEpochGroup_4_list{})
		}
		listValue := &_ModelEpochGroup_4_list{list: &x.ValidationWeights}
		return protoreflect.ValueOfList(listValue)
	case "inference.inference.ModelEpochGroup.total_weight":
		value := x.TotalWeight
		return protoreflect.ValueOfInt64(value)
	default:
		...
		panic(fmt.Errorf("message inference.inference.ModelEpochGroup does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ModelEpochGroup) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "inference.inference.ModelEpochGroup.model_id":
	...
	case "inference.inference.ModelEpochGroup.validation_weights":
		lv := value.List()
		clv := lv.(*_ModelEpochGroup_4_list)
		x.ValidationWeights = *clv.list
	case "inference.inference.ModelEpochGroup.total_weight":
		x.TotalWeight = value.Int()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ModelEpochGroup) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.ModelEpochGroup.validation_weights":
		if x.ValidationWeights == nil {
			x.ValidationWeights = []*ValidationWeight{}
		}
		value := &_ModelEpochGroup_4_list{list: &x.ValidationWeights}
		return protoreflect.ValueOfList(value)
	case "inference.inference.ModelEpochGroup.model_id":
		panic(fmt.Errorf("field model_id of message inference.inference.ModelEpochGroup is not mutable"))
	case "inference.inference.ModelEpochGroup.epoch_group_id":
		panic(fmt.Errorf("field epoch_group_id of message inference.inference.ModelEpochGroup is not mutable"))
	case "inference.inference.ModelEpochGroup.epoch_policy":
		panic(fmt.Errorf("field epoch_policy of message inference.inference.ModelEpochGroup is not mutable"))
	case "inference.inference.ModelEpochGroup.total_weight":
		panic(fmt.Errorf("field total_weight of message inference.inference.ModelEpochGroup is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ModelEpochGroup"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ModelEpochGroup) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.ModelEpochGroup.model_id":
		return protoreflect.ValueOfString("")
	case "inference.inference.ModelEpochGroup.epoch_group_id":
	...
	case "inference.inference.ModelEpochGroup.validation_weights":
		list := []*ValidationWeight{}
		return protoreflect.ValueOfList(&_ModelEpochGroup_4_list{list: &list})
	case "inference.inference.ModelEpochGroup.total_weight":
		return protoreflect.ValueOfInt64(int64(0))
	default:
		if fd.IsExtension() {
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ModelEpochGroup) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in inference.inference.ModelEpochGroup", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ModelEpochGroup) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ModelEpochGroup) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ModelEpochGroup) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ModelEpochGroup) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ModelEpochGroup)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ModelEpochGroup: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ModelEpochGroup: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
type EpochGroupData struct {
	...
	// Nested EpochGroups per model
	ModelEpochGroups []*ModelEpochGroup `protobuf:"bytes,14,rep,name=model_epoch_groups,json=modelEpochGroups,proto3" json:"model_epoch_groups,omitempty"`
}
...
func (x *EpochGroupData) GetModelEpochGroups() []*ModelEpochGroup {
	if x != nil {
		return x.ModelEpochGroups
	}
	return nil
}

// ModelEpochGroup represents a nested EpochGroup for a specific model
type ModelEpochGroup struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	EpochGroupId      uint64              `protobuf:"varint,2,opt,name=epoch_group_id,json=epochGroupId,proto3" json:"epoch_group_id,omitempty"`
	EpochPolicy       string              `protobuf:"bytes,3,opt,name=epoch_policy,json=epochPolicy,proto3" json:"epoch_policy,omitempty"`
	ValidationWeights []*ValidationWeight `protobuf:"bytes,4,rep,name=validation_weights,json=validationWeights,proto3" json:"validation_weights,omitempty"`
	TotalWeight       int64               `protobuf:"varint,5,opt,name=total_weight,json=totalWeight,proto3" json:"total_weight,omitempty"`
}

func (x *ModelEpochGroup) Reset() {
	*x = ModelEpochGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_inference_inference_epoch_group_data_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *ModelEpochGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ModelEpochGroup) ProtoMessage() {}

// Deprecated: Use ModelEpochGroup.ProtoReflect.Descriptor instead.
func (*ModelEpochGroup) Descriptor() ([]byte, []int) {
	return file_inference_inference_epoch_group_data_proto_rawDescGZIP(), []int{1}
}

func (x *ModelEpochGroup) GetModelId() string {
	if x != nil {
		return x.ModelId
	}
	return ""
...
func (x *ModelEpochGroup) GetEpochGroupId() uint64 {
	if x != nil {
		return x.EpochGroupId
	}
	return 0
...
func (x *ModelEpochGroup) GetEpochPolicy() string {
	if x != nil {
		return x.EpochPolicy
	}
	return ""
...
func (x *ModelEpochGroup) GetValidationWeights() []*ValidationWeight {
	if x != nil {
		return x.ValidationWeights
	}
	return nil
...
func (x *ModelEpochGroup) GetTotalWeight() int64 {
	if x != nil {
		return x.TotalWeight
	}
	return 0
...
var file_inference_inference_epoch_group_data_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x06, 0x0a, 0x0e, 0x45,
	...
	,
	...
	,
...
var file_inference_inference_epoch_group_data_proto_goTypes = []interface{}{
	...
	(*ModelEpochGroup)(nil),  // 1: inference.inference.ModelEpochGroup
...
var file_inference_inference_epoch_group_data_proto_depIdxs = []int32{
	...
	1, // 3: inference.inference.EpochGroupData.model_epoch_groups:type_name -> inference.inference.ModelEpochGroup
	2, // 4: inference.inference.ModelEpochGroup.validation_weights:type_name -> inference.inference.ValidationWeight
