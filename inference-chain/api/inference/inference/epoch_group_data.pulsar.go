...
func (x *_EpochGroupData_7_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*InferenceDetail)
	(*x.list)[i] = concreteValue
}
...
func (x *fastReflection_EpochGroupData) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.FinishedInferences) > 0 {
			for _, e := range x.FinishedInferences {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.FinishedInferences) > 0 {
			for iNdEx := len(x.FinishedInferences) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.FinishedInferences[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				...
				x.FinishedInferences = append(x.FinishedInferences, &InferenceDetail{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.FinishedInferences[len(x.FinishedInferences)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 8:
...
var (
	...
	fd_InferenceDetail_traffic_basis       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_InferenceDetail_traffic_basis = md_InferenceDetail.Fields().ByName("traffic_basis")
}

var _ protoreflect.Message = (*fastReflection_InferenceDetail)(nil)

type fastReflection_InferenceDetail InferenceDetail

func (x *InferenceDetail) ProtoReflect() protoreflect.Message {
	return (*fastReflection_InferenceDetail)(x)
}

func (x *InferenceDetail) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_InferenceDetail_messageType fastReflection_InferenceDetail_messageType
var _ protoreflect.MessageType = fastReflection_InferenceDetail_messageType{}

type fastReflection_InferenceDetail_messageType struct{}

func (x fastReflection_InferenceDetail_messageType) Zero() protoreflect.Message {
	return (*fastReflection_InferenceDetail)(nil)
}
func (x fastReflection_InferenceDetail_messageType) New() protoreflect.Message {
	return new(fastReflection_InferenceDetail)
}
func (x fastReflection_InferenceDetail_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_InferenceDetail
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_InferenceDetail) Descriptor() protoreflect.MessageDescriptor {
	return md_InferenceDetail
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_InferenceDetail) Type() protoreflect.MessageType {
	return _fastReflection_InferenceDetail_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_InferenceDetail) New() protoreflect.Message {
	return new(fastReflection_InferenceDetail)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_InferenceDetail) Interface() protoreflect.ProtoMessage {
	return (*InferenceDetail)(x)
}
...
func (x *fastReflection_InferenceDetail) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Executor != "" {
		...
		if !f(fd_InferenceDetail_executor, value) {
			return
		}
	}
	if x.ExecutorReputation != float64(0) || math.Signbit(x.ExecutorReputation) {
		value := protoreflect.ValueOfFloat64(x.ExecutorReputation)
	...
	if x.TrafficBasis != uint64(0) {
		...
		if !f(fd_InferenceDetail_traffic_basis, value) {
			return
		}
	}
}
...
func (x *fastReflection_InferenceDetail) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.InferenceDetail.executor_reputation":
		return x.ExecutorReputation != float64(0) || math.Signbit(x.ExecutorReputation)
	case "inference.inference.InferenceDetail.traffic_basis":
	...
	default:
		...
		panic(fmt.Errorf("message inference.inference.InferenceDetail does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_InferenceDetail) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "inference.inference.InferenceDetail.executor":
		x.Executor = ""
	case "inference.inference.InferenceDetail.executor_reputation":
		x.ExecutorReputation = float64(0)
	case "inference.inference.InferenceDetail.traffic_basis":
...
func (x *fastReflection_InferenceDetail) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message inference.inference.InferenceDetail does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_InferenceDetail) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.InferenceDetail.executor_reputation":
		x.ExecutorReputation = value.Float()
	case "inference.inference.InferenceDetail.traffic_basis":
...
func (x *fastReflection_InferenceDetail) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.InferenceDetail.traffic_basis":
		panic(fmt.Errorf("field traffic_basis of message inference.inference.InferenceDetail is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.InferenceDetail"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_InferenceDetail) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in inference.inference.InferenceDetail", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_InferenceDetail) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_InferenceDetail) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_InferenceDetail) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_InferenceDetail) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*InferenceDetail)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		if x.ExecutorReputation != 0 || math.Signbit(x.ExecutorReputation) {
			n += 9
		}
		if x.TrafficBasis != 0 {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ExecutorReputation != 0 || math.Signbit(x.ExecutorReputation) {
			i -= 8
			binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(x.ExecutorReputation))))
			i--
			dAtA[i] = 0x19
		}
		if len(x.Executor) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: InferenceDetail: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: InferenceDetail: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 3:
				...
				iNdEx += 8
				x.ExecutorReputation = float64(math.Float64frombits(v))
			case 4:
				if wireType != 0 {
...
func (x *EpochGroupData) GetFinishedInferences() []*InferenceDetail {
	if x != nil {
...
func (x *InferenceDetail) GetExecutor() string {
	if x != nil {
		return x.Executor
	}
	return ""
...
func (x *InferenceDetail) GetExecutorReputation() float64 {
	if x != nil {
...
func (x *InferenceDetail) GetTrafficBasis() uint64 {
	if x != nil {
...
var file_inference_inference_epoch_group_data_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe4, 0x05, 0x0a, 0x0e, 0x45,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x55, 0x0a, 0x13, 0x66, 0x69, 0x6e, 0x69, 0x73,
	0x68, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x07,
	...
	,
...
var file_inference_inference_epoch_group_data_proto_goTypes = []interface{}{
	...
	(*InferenceDetail)(nil),  // 1: inference.inference.InferenceDetail
...
var file_inference_inference_epoch_group_data_proto_depIdxs = []int32{
	...
	4, // 3: inference.inference.EpochGroupData.validation_params:type_name -> inference.inference.ValidationParams
