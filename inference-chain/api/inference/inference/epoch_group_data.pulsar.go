...
func (x *_EpochGroupData_15_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message EpochGroupData at list field SubGroupHeights as it is not of Message kind"))
}
...
var (
	...
	fd_EpochGroupData_sub_group_heights       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EpochGroupData_sub_group_heights = md_EpochGroupData.Fields().ByName("sub_group_heights")
}
...
func (x *fastReflection_EpochGroupData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.SubGroupHeights) != 0 {
		value := protoreflect.ValueOfList(&_EpochGroupData_15_list{list: &x.SubGroupHeights})
		if !f(fd_EpochGroupData_sub_group_heights, value) {
			return
		}
	}
}
...
func (x *fastReflection_EpochGroupData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.EpochGroupData.model_id":
		return x.ModelId != ""
	case "inference.inference.EpochGroupData.sub_group_heights":
		return len(x.SubGroupHeights) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EpochGroupData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupData.sub_group_heights":
		...
		listValue := &_EpochGroupData_15_list{list: &x.SubGroupHeights}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_EpochGroupData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupData.sub_group_heights":
		if x.SubGroupHeights == nil {
			x.SubGroupHeights = []uint64{}
		}
		value := &_EpochGroupData_15_list{list: &x.SubGroupHeights}
		return protoreflect.ValueOfList(value)
	case "inference.inference.EpochGroupData.poc_start_block_height":
...
func (x *fastReflection_EpochGroupData) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.SubGroupHeights) > 0 {
			l = 0
			for _, e := range x.SubGroupHeights {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.SubGroupHeights) > 0 {
			var pksize2 int
			for _, num := range x.SubGroupHeights {
		...
		for iNdEx < l {
			...
			case 15:
				if wireType == 0 {
					...
					x.SubGroupHeights = append(x.SubGroupHeights, v)
				} else if wireType == 2 {
					var packedLen int
					for shift := uint(0); ; shift += 7 {
						if shift >= 64 {
					...
					elementCount = count
					if elementCount != 0 && len(x.SubGroupHeights) == 0 {
						x.SubGroupHeights = make([]uint64, 0, elementCount)
					}
					for iNdEx < postIndex {
						var v uint64
						for shift := uint(0); ; shift += 7 {
					...
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SubGroupHeights", wireType)
				}
			default:
				iNdEx = preIndex
...
func (x *EpochGroupData) GetSubGroupHeights() []uint64 {
	if x != nil {
		return x.SubGroupHeights
	}
	return nil
}
...
var file_inference_inference_epoch_group_data_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x05, 0x0a, 0x0e, 0x45,
	...
	0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x75, 0x62, 0x5f,
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x73, 0x18, 0x0f, 0x20,
	0x03, 0x28, 0x04, 0x52, 0x0f, 0x73, 0x75, 0x62, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x48, 0x65, 0x69,
	0x67, 0x68, 0x74, 0x73, 0x22, 0x71, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69,
	...
	0x75, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x54, 0x0a, 0x0d, 0x53, 0x65, 0x65, 0x64, 0x53,
	...
	0x28, 0x09, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0xc1, 0x01,
