...
var (
	...
	fd_ValidationWeight_collateral_weight_ratio protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ValidationWeight_collateral_weight_ratio = md_ValidationWeight.Fields().ByName("collateral_weight_ratio")
}
...
func (x *fastReflection_ValidationWeight) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CollateralWeightRatio != nil {
		...
		if !f(fd_ValidationWeight_collateral_weight_ratio, value) {
			return
		}
	}
}
...
func (x *fastReflection_ValidationWeight) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.ValidationWeight.collateral_weight_ratio":
...
func (x *ValidationWeight) GetCollateralWeightRatio() *Decimal {
	if x != nil {
...
var file_inference_inference_epoch_group_data_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x22, 0xb4, 0x02, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f,
	...
	0x67, 0x68, 0x74, 0x12, 0x54, 0x0a, 0x17, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61,
	0x6c, 0x5f, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x5f, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x18, 0x06,
	...
	0x69, 0x67, 0x68, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x22, 0x54, 0x0a, 0x0d, 0x53, 0x65, 0x65,
...
var file_inference_inference_epoch_group_data_proto_depIdxs = []int32{
	...
	7, // 5: inference.inference.ValidationWeight.collateral_weight_ratio:type_name -> inference.inference.Decimal
