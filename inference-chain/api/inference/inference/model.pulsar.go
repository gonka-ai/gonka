...
var (
	...
	fd_Model_submitted_by              protoreflect.FieldDescriptor
	fd_Model_id                        protoreflect.FieldDescriptor
	fd_Model_unit_of_compute_per_token protoreflect.FieldDescriptor
)

func init() {
	file_inference_inference_model_proto_init()
	md_Model = File_inference_inference_model_proto.Messages().ByName("Model")
	fd_Model_submitted_by = md_Model.Fields().ByName("submitted_by")
	fd_Model_id = md_Model.Fields().ByName("id")
	fd_Model_unit_of_compute_per_token = md_Model.Fields().ByName("unit_of_compute_per_token")
}
...
func (x *fastReflection_Model) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.SubmittedBy != "" {
		...
		if !f(fd_Model_submitted_by, value) {
			return
		}
	}
	if x.Id != "" {
	...
	if x.UnitOfComputePerToken != uint64(0) {
		...
		if !f(fd_Model_unit_of_compute_per_token, value) {
			return
		}
	}
}
...
func (x *fastReflection_Model) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.inference.Model.submitted_by":
		return x.SubmittedBy != ""
	case "inference.inference.Model.id":
		return x.Id != ""
	case "inference.inference.Model.unit_of_compute_per_token":
...
func (x *fastReflection_Model) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.Model.submitted_by":
		panic(fmt.Errorf("field submitted_by of message inference.inference.Model is not mutable"))
	case "inference.inference.Model.id":
		panic(fmt.Errorf("field id of message inference.inference.Model is not mutable"))
	case "inference.inference.Model.unit_of_compute_per_token":
		panic(fmt.Errorf("field unit_of_compute_per_token of message inference.inference.Model is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.Model"))
		}
...
func (x *Model) GetSubmittedBy() string {
	if x != nil {
		return x.SubmittedBy
	}
	return ""
...
func (x *Model) GetUnitOfComputePerToken() uint64 {
	if x != nil {
...
var file_inference_inference_model_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x12, 0x38, 0x0a, 0x19, 0x75, 0x6e, 0x69, 0x74, 0x5f, 0x6f, 0x66, 0x5f, 0x63, 0x6f,
	0x6d, 0x70, 0x75, 0x74, 0x65, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x75, 0x6e, 0x69, 0x74, 0x4f, 0x66, 0x43, 0x6f, 0x6d,
