...
var (
	...
	fd_InferenceValidationDetails_epoch_index         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_InferenceValidationDetails_epoch_index = md_InferenceValidationDetails.Fields().ByName("epoch_index")
}
...
func (x *fastReflection_InferenceValidationDetails) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EpochIndex != uint64(0) {
		...
		if !f(fd_InferenceValidationDetails_epoch_index, value) {
			return
		}
	}
}
...
func (x *fastReflection_InferenceValidationDetails) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.InferenceValidationDetails.epoch_index":
...
func (x *fastReflection_InferenceValidationDetails) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.InferenceValidationDetails.epoch_index":
		panic(fmt.Errorf("field epoch_index of message inference.inference.InferenceValidationDetails is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.InferenceValidationDetails"))
		}
...
type InferenceValidationDetails struct {
	...
	EpochId            uint64 `protobuf:"varint,1,opt,name=epoch_id,json=epochId,proto3" json:"epoch_id,omitempty"` // poc start block height
...
func (x *InferenceValidationDetails) GetEpochIndex() uint64 {
	if x != nil {
		return x.EpochIndex
	}
	return 0
...
var file_inference_inference_inference_validation_details_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0xd0, 0x02,
	...
	0x1f, 0x0a, 0x0b, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x49, 0x6e, 0x64, 0x65, 0x78,
	0x42, 0xcd, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x1f, 0x49, 0x6e,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
