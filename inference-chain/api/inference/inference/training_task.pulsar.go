...
var (
	...
	fd_TrainingTask_assigner_locked_at_block_height protoreflect.FieldDescriptor
...
func init() {
	...
	fd_TrainingTask_assigner_locked_at_block_height = md_TrainingTask.Fields().ByName("assigner_locked_at_block_height")
...
func (x *fastReflection_TrainingTask) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.AssignerLockedAtBlockHeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.AssignerLockedAtBlockHeight)
		if !f(fd_TrainingTask_assigner_locked_at_block_height, value) {
			return
		}
	}
...
func (x *fastReflection_TrainingTask) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.TrainingTask.assigner":
		return x.Assigner != ""
	case "inference.inference.TrainingTask.assigner_locked_at_block_height":
		return x.AssignerLockedAtBlockHeight != uint64(0)
...
func (x *fastReflection_TrainingTask) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "inference.inference.TrainingTask.assigner":
		x.Assigner = ""
	case "inference.inference.TrainingTask.assigner_locked_at_block_height":
		x.AssignerLockedAtBlockHeight = uint64(0)
	case "inference.inference.TrainingTask.assigned_at_block_height":
...
func (x *fastReflection_TrainingTask) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.TrainingTask.assigner":
		...
		return protoreflect.ValueOfString(value)
	case "inference.inference.TrainingTask.assigner_locked_at_block_height":
		value := x.AssignerLockedAtBlockHeight
		return protoreflect.ValueOfUint64(value)
	case "inference.inference.TrainingTask.assigned_at_block_height":
...
func (x *fastReflection_TrainingTask) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.TrainingTask.assigner_locked_at_block_height":
		x.AssignerLockedAtBlockHeight = value.Uint()
	case "inference.inference.TrainingTask.assigned_at_block_height":
...
func (x *fastReflection_TrainingTask) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.TrainingTask.assigner_locked_at_block_height":
		panic(fmt.Errorf("field assigner_locked_at_block_height of message inference.inference.TrainingTask is not mutable"))
	case "inference.inference.TrainingTask.assigned_at_block_height":
...
func (x *fastReflection_TrainingTask) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.AssignerLockedAtBlockHeight != 0 {
			n += 1 + runtime.Sov(uint64(x.AssignerLockedAtBlockHeight))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.AssignerLockedAtBlockHeight != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.AssignerLockedAtBlockHeight))
			i--
			dAtA[i] = 0x28
		}
		if len(x.Assigner) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AssignerLockedAtBlockHeight", wireType)
				}
				x.AssignerLockedAtBlockHeight = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.AssignerLockedAtBlockHeight |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *TrainingTask) GetAssignerLockedAtBlockHeight() uint64 {
	if x != nil {
		return x.AssignerLockedAtBlockHeight
	}
	return 0
}
...
var file_inference_inference_training_task_proto_rawDesc = []byte{
	...
	0x03, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x54, 0x61, 0x73, 0x6b, 0x12,
	...
	,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x69,
	...
	0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x45, 0x0a, 0x19, 0x54, 0x72, 0x61,
	0x69, 0x6e, 0x69, 0x6e, 0x67, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01,
	...
	,
...
var file_inference_inference_training_task_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_inference_inference_training_task_proto_depIdxs = []int32{
	...
	3, // 2: inference.inference.TrainingConfig.datasets:type_name -> inference.inference.TrainingDatasets
