...
var file_inference_inference_tx_proto_rawDesc = []byte{
	...
	0x22, 0xa1, 0x01, 0x0a, 0x15, 0x4d, 0x73, 0x67, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x54, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x47, 0x0a,
	...
	0x61, 0x73, 0x6b, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x65, 0x52, 0x09, 0x61, 0x73, 0x73,
	0x69, 0x67, 0x6e, 0x65, 0x65, 0x73, 0x3a, 0x0c, 0x82, 0xe7, 0xb0, 0x2a, 0x07, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x6f, 0x72, 0x22, 0x1f, 0x0a, 0x1d, 0x4d, 0x73, 0x67, 0x41, 0x73, 0x73, 0x69, 0x67,
	0x6e, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd2, 0x10, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x62, 0x0a,
...
var file_inference_inference_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_inference_inference_tx_proto_goTypes = []interface{}{
	...
	(*TrainingHardwareResources)(nil),                   // 37: inference.inference.TrainingHardwareResources
	(*TrainingConfig)(nil),                              // 38: inference.inference.TrainingConfig
	(*TrainingTask)(nil),                                // 39: inference.inference.TrainingTask
	(*HardwareNode)(nil),                                // 40: inference.inference.HardwareNode
	(*TrainingTaskAssignee)(nil),                        // 41: inference.inference.TrainingTaskAssignee
}
var file_inference_inference_tx_proto_depIdxs = []int32{
	36, // 0: inference.inference.MsgUpdateParams.params:type_name -> inference.inference.Params
	37, // 1: inference.inference.MsgCreateTrainingTask.hardware_resources:type_name -> inference.inference.TrainingHardwareResources
	38, // 2: inference.inference.MsgCreateTrainingTask.config:type_name -> inference.inference.TrainingConfig
	39, // 3: inference.inference.MsgCreateTrainingTaskResponse.task:type_name -> inference.inference.TrainingTask
	40, // 4: inference.inference.MsgSubmitHardwareDiff.newOrModified:type_name -> inference.inference.HardwareNode
	40, // 5: inference.inference.MsgSubmitHardwareDiff.removed:type_name -> inference.inference.HardwareNode
	41, // 6: inference.inference.MsgAssignTrainingTask.assignees:type_name -> inference.inference.TrainingTaskAssignee
	...
	32, // 23: inference.inference.Msg.ClaimTrainingTaskForAssignment:input_type -> inference.inference.MsgClaimTrainingTaskForAssignment
	34, // 24: inference.inference.Msg.AssignTrainingTask:input_type -> inference.inference.MsgAssignTrainingTask
	1,  // 25: inference.inference.Msg.UpdateParams:output_type -> inference.inference.MsgUpdateParamsResponse
	3,  // 26: inference.inference.Msg.StartInference:output_type -> inference.inference.MsgStartInferenceResponse
	5,  // 27: inference.inference.Msg.FinishInference:output_type -> inference.inference.MsgFinishInferenceResponse
	7,  // 28: inference.inference.Msg.SubmitNewParticipant:output_type -> inference.inference.MsgSubmitNewParticipantResponse
	9,  // 29: inference.inference.Msg.Validation:output_type -> inference.inference.MsgValidationResponse
	11, // 30: inference.inference.Msg.SubmitNewUnfundedParticipant:output_type -> inference.inference.MsgSubmitNewUnfundedParticipantResponse
	13, // 31: inference.inference.Msg.InvalidateInference:output_type -> inference.inference.MsgInvalidateInferenceResponse
	15, // 32: inference.inference.Msg.RevalidateInference:output_type -> inference.inference.MsgRevalidateInferenceResponse
	17, // 33: inference.inference.Msg.ClaimRewards:output_type -> inference.inference.MsgClaimRewardsResponse
	19, // 34: inference.inference.Msg.SubmitPocBatch:output_type -> inference.inference.MsgSubmitPocBatchResponse
	21, // 35: inference.inference.Msg.SubmitPocValidation:output_type -> inference.inference.MsgSubmitPocValidationResponse
	23, // 36: inference.inference.Msg.SubmitSeed:output_type -> inference.inference.MsgSubmitSeedResponse
	25, // 37: inference.inference.Msg.SubmitUnitOfComputePriceProposal:output_type -> inference.inference.MsgSubmitUnitOfComputePriceProposalResponse
	27, // 38: inference.inference.Msg.RegisterModel:output_type -> inference.inference.MsgRegisterModelResponse
	29, // 39: inference.inference.Msg.CreateTrainingTask:output_type -> inference.inference.MsgCreateTrainingTaskResponse
	31, // 40: inference.inference.Msg.SubmitHardwareDiff:output_type -> inference.inference.MsgSubmitHardwareDiffResponse
	33, // 41: inference.inference.Msg.ClaimTrainingTaskForAssignment:output_type -> inference.inference.MsgClaimTrainingTaskForAssignmentResponse
	35, // 42: inference.inference.Msg.AssignTrainingTask:output_type -> inference.inference.MsgAssignTrainingTaskResponse
