...
var (
	...
	fd_MsgRegisterModel_unit_of_compute_per_token protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgRegisterModel_unit_of_compute_per_token = md_MsgRegisterModel.Fields().ByName("unit_of_compute_per_token")
}
...
func (x *fastReflection_MsgRegisterModel) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.UnitOfComputePerToken != uint64(0) {
		...
		if !f(fd_MsgRegisterModel_unit_of_compute_per_token, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgRegisterModel) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.MsgRegisterModel.id":
		return x.Id != ""
	case "inference.inference.MsgRegisterModel.unit_of_compute_per_token":
...
func (x *fastReflection_MsgRegisterModel) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.MsgRegisterModel.unit_of_compute_per_token":
		panic(fmt.Errorf("field unit_of_compute_per_token of message inference.inference.MsgRegisterModel is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.MsgRegisterModel"))
		}
...
var file_inference_inference_tx_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x84, 0x01, 0x0a, 0x10, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x64, 0x12, 0x38, 0x0a, 0x19, 0x75, 0x6e, 0x69, 0x74, 0x5f, 0x6f, 0x66, 0x5f, 0x63, 0x6f, 0x6d,
