...
var file_inference_inference_tx_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x63, 0x0a, 0x23, 0x4d, 0x73, 0x67, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x55,
	...
	0x74, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x3a, 0x0c, 0x82, 0xe7, 0xb0, 0x2a, 0x07,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x2d, 0x0a, 0x2b, 0x4d, 0x73, 0x67, 0x53, 0x75,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xc9, 0x0c, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x62,
	...
	0x2a, 0x01, 0x42, 0xb5, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x07,
...
var file_inference_inference_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_inference_inference_tx_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                                      // 28: inference.inference.Params
}
var file_inference_inference_tx_proto_depIdxs = []int32{
	28, // 0: inference.inference.MsgUpdateParams.params:type_name -> inference.inference.Params
	...
	1,  // 15: inference.inference.Msg.UpdateParams:output_type -> inference.inference.MsgUpdateParamsResponse
	3,  // 16: inference.inference.Msg.StartInference:output_type -> inference.inference.MsgStartInferenceResponse
	5,  // 17: inference.inference.Msg.FinishInference:output_type -> inference.inference.MsgFinishInferenceResponse
	7,  // 18: inference.inference.Msg.SubmitNewParticipant:output_type -> inference.inference.MsgSubmitNewParticipantResponse
	9,  // 19: inference.inference.Msg.Validation:output_type -> inference.inference.MsgValidationResponse
	11, // 20: inference.inference.Msg.SubmitPoC:output_type -> inference.inference.MsgSubmitPoCResponse
	13, // 21: inference.inference.Msg.SubmitNewUnfundedParticipant:output_type -> inference.inference.MsgSubmitNewUnfundedParticipantResponse
	15, // 22: inference.inference.Msg.InvalidateInference:output_type -> inference.inference.MsgInvalidateInferenceResponse
	17, // 23: inference.inference.Msg.RevalidateInference:output_type -> inference.inference.MsgRevalidateInferenceResponse
	19, // 24: inference.inference.Msg.ClaimRewards:output_type -> inference.inference.MsgClaimRewardsResponse
	21, // 25: inference.inference.Msg.SubmitPocBatch:output_type -> inference.inference.MsgSubmitPocBatchResponse
	23, // 26: inference.inference.Msg.SubmitPocValidation:output_type -> inference.inference.MsgSubmitPocValidationResponse
	25, // 27: inference.inference.Msg.SubmitSeed:output_type -> inference.inference.MsgSubmitSeedResponse
	27, // 28: inference.inference.Msg.SubmitUnitOfComputePriceProposal:output_type -> inference.inference.MsgSubmitUnitOfComputePriceProposalResponse
