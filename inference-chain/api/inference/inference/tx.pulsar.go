...
var (
	...
	fd_MsgRegisterModel_unitOfComputePerToken protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgRegisterModel_unitOfComputePerToken = md_MsgRegisterModel.Fields().ByName("unitOfComputePerToken")
}
...
func (x *fastReflection_MsgRegisterModel) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.UnitOfComputePerToken != uint64(0) {
		value := protoreflect.ValueOfUint64(x.UnitOfComputePerToken)
		if !f(fd_MsgRegisterModel_unitOfComputePerToken, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgRegisterModel) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.MsgRegisterModel.id":
		return x.Id != ""
	case "inference.inference.MsgRegisterModel.unitOfComputePerToken":
		return x.UnitOfComputePerToken != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgRegisterModel) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "inference.inference.MsgRegisterModel.id":
		x.Id = ""
	case "inference.inference.MsgRegisterModel.unitOfComputePerToken":
		x.UnitOfComputePerToken = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.MsgRegisterModel"))
		}
...
func (x *fastReflection_MsgRegisterModel) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.MsgRegisterModel.id":
		x.Id = value.Interface().(string)
	case "inference.inference.MsgRegisterModel.unitOfComputePerToken":
		x.UnitOfComputePerToken = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.MsgRegisterModel"))
		}
...
func (x *fastReflection_MsgRegisterModel) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.MsgRegisterModel.unitOfComputePerToken":
		panic(fmt.Errorf("field unitOfComputePerToken of message inference.inference.MsgRegisterModel is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.MsgRegisterModel"))
		}
...
func (x *fastReflection_MsgRegisterModel) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.UnitOfComputePerToken != 0 {
			n += 1 + runtime.Sov(uint64(x.UnitOfComputePerToken))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.UnitOfComputePerToken != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.UnitOfComputePerToken))
			i--
			dAtA[i] = 0x18
		}
		if len(x.Id) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UnitOfComputePerToken", wireType)
				}
				x.UnitOfComputePerToken = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.UnitOfComputePerToken |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *MsgRegisterModel) GetUnitOfComputePerToken() uint64 {
	if x != nil {
		return x.UnitOfComputePerToken
	}
	return 0
}
...
var file_inference_inference_tx_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x80, 0x01, 0x0a, 0x10, 0x4d, 0x73, 0x67, 0x52, 0x65,
	0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x63,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x34, 0x0a, 0x15, 0x75, 0x6e, 0x69, 0x74, 0x4f, 0x66, 0x43,
	0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x50, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x75, 0x6e, 0x69, 0x74, 0x4f, 0x66, 0x43, 0x6f, 0x6d, 0x70,
	0x75, 0x74, 0x65, 0x50, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x3a, 0x0c, 0x82, 0xe7, 0xb0,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xb0, 0x0d, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x62, 0x0a,
