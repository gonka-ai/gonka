...
func (x *fastReflection_MsgRegisterModel) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.inference.MsgRegisterModel.creator":
		return x.Creator != ""
...
func (x *fastReflection_MsgRegisterModel) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.MsgRegisterModel.creator":
		panic(fmt.Errorf("field creator of message inference.inference.MsgRegisterModel is not mutable"))
	case "inference.inference.MsgRegisterModel.id":
...
var file_inference_inference_tx_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x86, 0x01, 0x0a, 0x10, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x6d, 0x70, 0x75, 0x74, 0x65, 0x50, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x3a, 0x0c, 0x82,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xb0, 0x0d, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12,
