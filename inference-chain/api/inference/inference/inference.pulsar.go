...
var (
	...
	fd_Inference_start_block_hash             protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Inference_start_block_hash = md_Inference.Fields().ByName("start_block_hash")
}
...
func (x *fastReflection_Inference) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.StartBlockHash) != 0 {
		value := protoreflect.ValueOfBytes(x.StartBlockHash)
		if !f(fd_Inference_start_block_hash, value) {
			return
		}
	}
}
...
func (x *fastReflection_Inference) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.Inference.start_block_hash":
		return len(x.StartBlockHash) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Inference) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.Inference.start_block_hash":
		panic(fmt.Errorf("field start_block_hash of message inference.inference.Inference is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.Inference"))
		}
...
func (x *fastReflection_Inference) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.StartBlockHash) > 0 {
			i -= len(x.StartBlockHash)
			copy(dAtA[i:], x.StartBlockHash)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.StartBlockHash)))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0x92
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 34:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field StartBlockHash", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.StartBlockHash = append(x.StartBlockHash[:0], dAtA[iNdEx:postIndex]...)
				if x.StartBlockHash == nil {
					x.StartBlockHash = []byte{}
				}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type Inference struct {
	...
	StartBlockHash     []byte `protobuf:"bytes,34,opt,name=start_block_hash,json=startBlockHash,proto3" json:"start_block_hash,omitempty"`             // Block hash at StartBlockHeight, for voter sampling replay
}
...
func (x *Inference) GetStartBlockHash() []byte {
	if x != nil {
...
var file_inference_inference_inference_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x9f, 0x0b, 0x0a, 0x09, 0x49,
	...
	0x73, 0x68, 0x12, 0x28, 0x0a, 0x10, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63,
	0x6b, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x22, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x73, 0x74,
	0x61, 0x72, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x2a, 0x88, 0x01, 0x0a,
	...
	0x4f, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x58, 0x50, 0x49, 0x52,
	0x45, 0x44, 0x10, 0x05, 0x12, 0x21, 0x0a, 0x1d, 0x46, 0x49, 0x4e, 0x49, 0x53, 0x48, 0x45, 0x44,
	0x5f, 0x57, 0x49, 0x54, 0x48, 0x5f, 0x4d, 0x49, 0x53, 0x53, 0x49, 0x4e, 0x47, 0x5f, 0x50, 0x41,
	0x59, 0x4c, 0x4f, 0x41, 0x44, 0x10, 0x06, 0x42, 0xbc, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e,
