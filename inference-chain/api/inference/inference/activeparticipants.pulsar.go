...
func (x *ValidatorCommit) slowProtoReflect() protoreflect.Message {
	mi := &file_inference_inference_activeparticipants_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*ValidatorCommit) Descriptor() ([]byte, []int) {
	return file_inference_inference_activeparticipants_proto_rawDescGZIP(), []int{3}
}
...
var file_inference_inference_activeparticipants_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x85, 0x01, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x43,
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x76, 0x6f, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x73,
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09,
	0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0xc5, 0x01, 0x0a, 0x17, 0x63, 0x6f,
	0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x17, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x70, 0x61, 0x72,
	0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var file_inference_inference_activeparticipants_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_inference_inference_activeparticipants_proto_goTypes = []interface{}{
	...
	(*ValidatorCommit)(nil),    // 3: inference.inference.ValidatorCommit
	(*MLNodeInfo)(nil),         // 4: inference.inference.MLNodeInfo
	(*RandomSeed)(nil),         // 5: inference.inference.RandomSeed
}
var file_inference_inference_activeparticipants_proto_depIdxs = []int32{
	4, // 0: inference.inference.ModelMLNodes.ml_nodes:type_name -> inference.inference.MLNodeInfo
	2, // 1: inference.inference.ActiveParticipants.participants:type_name -> inference.inference.ActiveParticipant
	5, // 2: inference.inference.ActiveParticipant.seed:type_name -> inference.inference.RandomSeed
...
func file_inference_inference_activeparticipants_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_inference_inference_activeparticipants_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
