...
var (
	...
	fd_ActiveParticipants_cap_weight_applied      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ActiveParticipants_cap_weight_applied = md_ActiveParticipants.Fields().ByName("cap_weight_applied")
}
...
func (x *fastReflection_ActiveParticipants) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CapWeightApplied != false {
		value := protoreflect.ValueOfBool(x.CapWeightApplied)
		if !f(fd_ActiveParticipants_cap_weight_applied, value) {
			return
		}
	}
}
...
func (x *fastReflection_ActiveParticipants) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.ActiveParticipants.cap_weight_applied":
		return x.CapWeightApplied != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ActiveParticipants) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ActiveParticipants.cap_weight_applied":
		panic(fmt.Errorf("field cap_weight_applied of message inference.inference.ActiveParticipants is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ActiveParticipants"))
		}
...
func (x *fastReflection_ActiveParticipants) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CapWeightApplied", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
var (
	...
	fd_ActiveParticipant_cap_weight    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ActiveParticipant_cap_weight = md_ActiveParticipant.Fields().ByName("cap_weight")
}
...
func (x *fastReflection_ActiveParticipant) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CapWeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.CapWeight)
		if !f(fd_ActiveParticipant_cap_weight, value) {
			return
		}
	}
}
...
func (x *fastReflection_ActiveParticipant) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.ActiveParticipant.cap_weight":
		return x.CapWeight != int64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ActiveParticipant) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ActiveParticipant.cap_weight":
		panic(fmt.Errorf("field cap_weight of message inference.inference.ActiveParticipant is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ActiveParticipant"))
		}
...
func (x *fastReflection_ActiveParticipant) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.CapWeight != 0 {
			n += 1 + runtime.Sov(uint64(x.CapWeight))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.CapWeight != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.CapWeight))
			i--
			dAtA[i] = 0x48
		}
		if len(x.VotingPowers) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CapWeight", wireType)
				}
				x.CapWeight = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.CapWeight |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *ActiveParticipants) GetCapWeightApplied() bool {
	if x != nil {
		return x.CapWeightApplied
	}
	return false
}
...
func (x *ActiveParticipant) GetCapWeight() int64 {
	if x != nil {
		return x.CapWeight
	}
	return 0
...
var file_inference_inference_activeparticipants_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x6f, 0x52, 0x07, 0x6d, 0x6c, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0xf1, 0x02, 0x0a,
	...
	0x49, 0x64, 0x12, 0x2c, 0x0a, 0x12, 0x63, 0x61, 0x70, 0x5f, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74,
	0x5f, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10,
	0x63, 0x61, 0x70, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64,
	0x22, 0x81, 0x03, 0x0a, 0x11, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x50, 0x61, 0x72, 0x74, 0x69,
	0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x23, 0x0a, 0x0d,
	0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20,
	...
	,
