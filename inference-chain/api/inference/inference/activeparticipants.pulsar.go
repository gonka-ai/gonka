...
var _ protoreflect.List = (*_ActiveParticipants_8_list)(nil)

type _ActiveParticipants_8_list struct {
	list *[]*ValidatorCommit
}

func (x *_ActiveParticipants_8_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ActiveParticipants_8_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ActiveParticipants_8_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ValidatorCommit)
	(*x.list)[i] = concreteValue
}

func (x *_ActiveParticipants_8_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ValidatorCommit)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ActiveParticipants_8_list) AppendMutable() protoreflect.Value {
	v := new(ValidatorCommit)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ActiveParticipants_8_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ActiveParticipants_8_list) NewElement() protoreflect.Value {
	v := new(ValidatorCommit)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ActiveParticipants_8_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_ActiveParticipants_created_at_app_hash     protoreflect.FieldDescriptor
	fd_ActiveParticipants_commit_validators       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ActiveParticipants_created_at_app_hash = md_ActiveParticipants.Fields().ByName("created_at_app_hash")
	fd_ActiveParticipants_commit_validators = md_ActiveParticipants.Fields().ByName("commit_validators")
}
...
func (x *fastReflection_ActiveParticipants) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CreatedAtAppHash != "" {
		value := protoreflect.ValueOfString(x.CreatedAtAppHash)
		if !f(fd_ActiveParticipants_created_at_app_hash, value) {
			return
		}
	}
	if len(x.CommitValidators) != 0 {
		value := protoreflect.ValueOfList(&_ActiveParticipants_8_list{list: &x.CommitValidators})
		if !f(fd_ActiveParticipants_commit_validators, value) {
			return
		}
	}
}
...
func (x *fastReflection_ActiveParticipants) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.ActiveParticipants.created_at_app_hash":
		return x.CreatedAtAppHash != ""
	case "inference.inference.ActiveParticipants.commit_validators":
		return len(x.CommitValidators) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ActiveParticipants) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ActiveParticipants.epoch_id":
		...
		return protoreflect.ValueOfUint64(value)
	case "inference.inference.ActiveParticipants.created_at_app_hash":
		value := x.CreatedAtAppHash
		return protoreflect.ValueOfString(value)
	case "inference.inference.ActiveParticipants.commit_validators":
		if len(x.CommitValidators) == 0 {
			return protoreflect.ValueOfList(&_ActiveParticipants_8_list{})
		}
		listValue := &_ActiveParticipants_8_list{list: &x.CommitValidators}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_ActiveParticipants) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.ActiveParticipants.created_at_app_hash":
		x.CreatedAtAppHash = value.Interface().(string)
	case "inference.inference.ActiveParticipants.commit_validators":
		lv := value.List()
		clv := lv.(*_ActiveParticipants_8_list)
		x.CommitValidators = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ActiveParticipants"))
		}
...
func (x *fastReflection_ActiveParticipants) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ActiveParticipants.commit_validators":
		if x.CommitValidators == nil {
			x.CommitValidators = []*ValidatorCommit{}
		}
		value := &_ActiveParticipants_8_list{list: &x.CommitValidators}
		return protoreflect.ValueOfList(value)
	case "inference.inference.ActiveParticipants.epoch_group_id":
	...
	case "inference.inference.ActiveParticipants.created_at_app_hash":
		panic(fmt.Errorf("field created_at_app_hash of message inference.inference.ActiveParticipants is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ActiveParticipants"))
		}
...
func (x *fastReflection_ActiveParticipants) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ActiveParticipants.commit_validators":
		list := []*ValidatorCommit{}
		return protoreflect.ValueOfList(&_ActiveParticipants_8_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ActiveParticipants"))
		}
...
func (x *fastReflection_ActiveParticipants) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.CreatedAtAppHash)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if len(x.CommitValidators) > 0 {
			for _, e := range x.CommitValidators {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.CommitValidators) > 0 {
			for iNdEx := len(x.CommitValidators) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.CommitValidators[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.CreatedAtAppHash) > 0 {
			i -= len(x.CreatedAtAppHash)
			copy(dAtA[i:], x.CreatedAtAppHash)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.CreatedAtAppHash)))
			i--
			dAtA[i] = 0x3a
		}
		if x.EpochId != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CreatedAtAppHash", wireType)
				}
				...
				x.CreatedAtAppHash = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 8:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CommitValidators", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.CommitValidators = append(x.CommitValidators, &ValidatorCommit{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.CommitValidators[len(x.CommitValidators)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	md_ValidatorCommit              protoreflect.MessageDescriptor
	fd_ValidatorCommit_address      protoreflect.FieldDescriptor
	fd_ValidatorCommit_pub_key      protoreflect.FieldDescriptor
	fd_ValidatorCommit_voting_power protoreflect.FieldDescriptor
	fd_ValidatorCommit_signature    protoreflect.FieldDescriptor
)

func init() {
	file_inference_inference_activeparticipants_proto_init()
	md_ValidatorCommit = File_inference_inference_activeparticipants_proto.Messages().ByName("ValidatorCommit")
	fd_ValidatorCommit_address = md_ValidatorCommit.Fields().ByName("address")
	fd_ValidatorCommit_pub_key = md_ValidatorCommit.Fields().ByName("pub_key")
	fd_ValidatorCommit_voting_power = md_ValidatorCommit.Fields().ByName("voting_power")
	fd_ValidatorCommit_signature = md_ValidatorCommit.Fields().ByName("signature")
}

var _ protoreflect.Message = (*fastReflection_ValidatorCommit)(nil)

type fastReflection_ValidatorCommit ValidatorCommit

func (x *ValidatorCommit) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ValidatorCommit)(x)
}

func (x *ValidatorCommit) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ValidatorCommit_messageType fastReflection_ValidatorCommit_messageType
var _ protoreflect.MessageType = fastReflection_ValidatorCommit_messageType{}

type fastReflection_ValidatorCommit_messageType struct{}

func (x fastReflection_ValidatorCommit_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ValidatorCommit)(nil)
}
func (x fastReflection_ValidatorCommit_messageType) New() protoreflect.Message {
	return new(fastReflection_ValidatorCommit)
}
func (x fastReflection_ValidatorCommit_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ValidatorCommit
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ValidatorCommit) Descriptor() protoreflect.MessageDescriptor {
	return md_ValidatorCommit
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ValidatorCommit) Type() protoreflect.MessageType {
	return _fastReflection_ValidatorCommit_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ValidatorCommit) New() protoreflect.Message {
	return new(fastReflection_ValidatorCommit)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ValidatorCommit) Interface() protoreflect.ProtoMessage {
	return (*ValidatorCommit)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ValidatorCommit) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_ValidatorCommit_address, value) {
			return
		}
	}
	if x.PubKey != "" {
		value := protoreflect.ValueOfString(x.PubKey)
		if !f(fd_ValidatorCommit_pub_key, value) {
			return
		}
	}
	if x.VotingPower != int64(0) {
		value := protoreflect.ValueOfInt64(x.VotingPower)
		if !f(fd_ValidatorCommit_voting_power, value) {
			return
		}
	}
	if len(x.Signature) != 0 {
		value := protoreflect.ValueOfBytes(x.Signature)
		if !f(fd_ValidatorCommit_signature, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ValidatorCommit) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.inference.ValidatorCommit.address":
		return x.Address != ""
	case "inference.inference.ValidatorCommit.pub_key":
		return x.PubKey != ""
	case "inference.inference.ValidatorCommit.voting_power":
		return x.VotingPower != int64(0)
	case "inference.inference.ValidatorCommit.signature":
		return len(x.Signature) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ValidatorCommit"))
		}
		panic(fmt.Errorf("message inference.inference.ValidatorCommit does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorCommit) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "inference.inference.ValidatorCommit.address":
		x.Address = ""
	case "inference.inference.ValidatorCommit.pub_key":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ValidatorCommit) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "inference.inference.ValidatorCommit.address":
		value := x.Address
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message inference.inference.ValidatorCommit does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorCommit) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "inference.inference.ValidatorCommit.address":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorCommit) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.ValidatorCommit.address":
		panic(fmt.Errorf("field address of message inference.inference.ValidatorCommit is not mutable"))
	case "inference.inference.ValidatorCommit.pub_key":
		panic(fmt.Errorf("field pub_key of message inference.inference.ValidatorCommit is not mutable"))
	case "inference.inference.ValidatorCommit.voting_power":
		panic(fmt.Errorf("field voting_power of message inference.inference.ValidatorCommit is not mutable"))
	case "inference.inference.ValidatorCommit.signature":
		panic(fmt.Errorf("field signature of message inference.inference.ValidatorCommit is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ValidatorCommit"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ValidatorCommit) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.ValidatorCommit.address":
		return protoreflect.ValueOfString("")
	case "inference.inference.ValidatorCommit.pub_key":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ValidatorCommit) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in inference.inference.ValidatorCommit", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ValidatorCommit) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorCommit) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ValidatorCommit) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ValidatorCommit) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ValidatorCommit)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ValidatorCommit: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ValidatorCommit: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ActiveParticipants) GetCreatedAtAppHash() string {
	if x != nil {
		return x.CreatedAtAppHash
	}
	return ""
...
func (x *ActiveParticipants) GetCommitValidators() []*ValidatorCommit {
	if x != nil {
		return x.CommitValidators
	}
	return nil
}
...
func (x *ValidatorCommit) GetPubKey() string {
	if x != nil {
		return x.PubKey
	}
	return ""
...
func (x *ValidatorCommit) GetVotingPower() int64 {
	if x != nil {
...
func (x *ValidatorCommit) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_inference_inference_activeparticipants_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x03, 0x0a, 0x12, 0x41,
	...
	0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x69,
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x49, 0x64,
	0x12, 0x2d, 0x0a, 0x13, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x5f, 0x61,
	0x70, 0x70, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x41, 0x70, 0x70, 0x48, 0x61, 0x73, 0x68, 0x12,
	0x51, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x6f, 0x72, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x69, 0x6e, 0x66,
	...
	0x52, 0x10, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x73, 0x22, 0xd8, 0x01, 0x0a, 0x11, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x50, 0x61, 0x72,
	...
	0x64, 0x6f, 0x6d, 0x53, 0x65, 0x65, 0x64, 0x52, 0x04, 0x73, 0x65, 0x65, 0x64, 0x22, 0x85, 0x01,
	0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x69,
	...
	0x6e, 0x67, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0xc5, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	0x65, 0x42, 0x17, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x24, 0x63, 0x6f,
...
var file_inference_inference_activeparticipants_proto_goTypes = []interface{}{
	...
	(*ValidatorCommit)(nil),    // 2: inference.inference.ValidatorCommit
	(*RandomSeed)(nil),         // 3: inference.inference.RandomSeed
}
var file_inference_inference_activeparticipants_proto_depIdxs = []int32{
	...
	2, // 1: inference.inference.ActiveParticipants.commit_validators:type_name -> inference.inference.ValidatorCommit
	3, // 2: inference.inference.ActiveParticipant.seed:type_name -> inference.inference.RandomSeed
