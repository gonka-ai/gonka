...
var file_inference_inference_query_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x6f, 0x72, 0x22, 0x1f, 0x0a, 0x1d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x65, 0x74,
	...
	0x00, 0x52, 0x08, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x32, 0xfa, 0x09, 0x0a, 0x05,
	...
	0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x73, 0x7d, 0x12, 0xbd, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74,
	...
	0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x42, 0xb8, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d,
	0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x42, 0x0a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_inference_inference_query_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_inference_inference_query_proto_goTypes = []interface{}{
	...
	(*QueryGetRandomExecutorRequest)(nil),           // 13: inference.inference.QueryGetRandomExecutorRequest
	(*QueryGetRandomExecutorResponse)(nil),          // 14: inference.inference.QueryGetRandomExecutorResponse
	(*Params)(nil),                                  // 15: inference.inference.Params
	(*Inference)(nil),                               // 16: inference.inference.Inference
	...
	(*Participant)(nil),                             // 19: inference.inference.Participant
}
var file_inference_inference_query_proto_depIdxs = []int32{
	15, // 0: inference.inference.QueryParamsResponse.params:type_name -> inference.inference.Params
	16, // 1: inference.inference.QueryGetInferenceResponse.inference:type_name -> inference.inference.Inference
	17, // 2: inference.inference.QueryAllInferenceRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	16, // 3: inference.inference.QueryAllInferenceResponse.inference:type_name -> inference.inference.Inference
	18, // 4: inference.inference.QueryAllInferenceResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	19, // 5: inference.inference.QueryGetParticipantResponse.participant:type_name -> inference.inference.Participant
	17, // 6: inference.inference.QueryAllParticipantRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	19, // 7: inference.inference.QueryAllParticipantResponse.participant:type_name -> inference.inference.Participant
	18, // 8: inference.inference.QueryAllParticipantResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	16, // 10: inference.inference.InferenceWithExecutor.inference:type_name -> inference.inference.Inference
	19, // 11: inference.inference.InferenceWithExecutor.executor:type_name -> inference.inference.Participant
	19, // 12: inference.inference.QueryGetRandomExecutorResponse.executor:type_name -> inference.inference.Participant
	...
	13, // 19: inference.inference.Query.GetRandomExecutor:input_type -> inference.inference.QueryGetRandomExecutorRequest
	1,  // 20: inference.inference.Query.Params:output_type -> inference.inference.QueryParamsResponse
	3,  // 21: inference.inference.Query.Inference:output_type -> inference.inference.QueryGetInferenceResponse
	5,  // 22: inference.inference.Query.InferenceAll:output_type -> inference.inference.QueryAllInferenceResponse
	7,  // 23: inference.inference.Query.Participant:output_type -> inference.inference.QueryGetParticipantResponse
	9,  // 24: inference.inference.Query.ParticipantAll:output_type -> inference.inference.QueryAllParticipantResponse
	11, // 25: inference.inference.Query.GetInferencesWithExecutors:output_type -> inference.inference.QueryGetInferencesWithExecutorsResponse
	14, // 26: inference.inference.Query.GetRandomExecutor:output_type -> inference.inference.QueryGetRandomExecutorResponse
