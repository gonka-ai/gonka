...
var file_inference_inference_query_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x63, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x69,
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x42, 0xb8,
...
var file_inference_inference_query_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_inference_inference_query_proto_goTypes = []interface{}{
	...
	(*Inference)(nil),                   // 11: inference.inference.Inference
	...
	(*Participant)(nil),                 // 14: inference.inference.Participant
}
var file_inference_inference_query_proto_depIdxs = []int32{
	10, // 0: inference.inference.QueryParamsResponse.params:type_name -> inference.inference.Params
	11, // 1: inference.inference.QueryGetInferenceResponse.inference:type_name -> inference.inference.Inference
	12, // 2: inference.inference.QueryAllInferenceRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	11, // 3: inference.inference.QueryAllInferenceResponse.inference:type_name -> inference.inference.Inference
	13, // 4: inference.inference.QueryAllInferenceResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	14, // 5: inference.inference.QueryGetParticipantResponse.participant:type_name -> inference.inference.Participant
	12, // 6: inference.inference.QueryAllParticipantRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	14, // 7: inference.inference.QueryAllParticipantResponse.participant:type_name -> inference.inference.Participant
	13, // 8: inference.inference.QueryAllParticipantResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	0,  // 9: inference.inference.Query.Params:input_type -> inference.inference.QueryParamsRequest
	2,  // 10: inference.inference.Query.Inference:input_type -> inference.inference.QueryGetInferenceRequest
	4,  // 11: inference.inference.Query.InferenceAll:input_type -> inference.inference.QueryAllInferenceRequest
	6,  // 12: inference.inference.Query.Participant:input_type -> inference.inference.QueryGetParticipantRequest
	8,  // 13: inference.inference.Query.ParticipantAll:input_type -> inference.inference.QueryAllParticipantRequest
	1,  // 14: inference.inference.Query.Params:output_type -> inference.inference.QueryParamsResponse
	3,  // 15: inference.inference.Query.Inference:output_type -> inference.inference.QueryGetInferenceResponse
	5,  // 16: inference.inference.Query.InferenceAll:output_type -> inference.inference.QueryAllInferenceResponse
	7,  // 17: inference.inference.Query.Participant:output_type -> inference.inference.QueryGetParticipantResponse
	9,  // 18: inference.inference.Query.ParticipantAll:output_type -> inference.inference.QueryAllParticipantResponse
