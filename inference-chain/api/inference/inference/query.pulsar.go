...
var file_inference_inference_query_proto_rawDesc = []byte{
	...
	0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x30, 0x0a,
	0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e,
	...
	0x5f, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x65, 0x72,
	...
	0x22, 0x62, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x49, 0x6e, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x46, 0x0a, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa8, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x6c,
	...
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	...
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x47, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61,
	...
	0xec, 0x03, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x8f, 0x01, 0x0a, 0x06, 0x50, 0x61,
	...
	0x2f, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x69, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x2f, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0xb8,
...
var file_inference_inference_query_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_inference_inference_query_proto_goTypes = []interface{}{
	...
	(*Inference)(nil),                 // 7: inference.inference.Inference
...
var file_inference_inference_query_proto_depIdxs = []int32{
	6, // 0: inference.inference.QueryParamsResponse.params:type_name -> inference.inference.Params
	7, // 1: inference.inference.QueryGetInferenceResponse.inference:type_name -> inference.inference.Inference
	8, // 2: inference.inference.QueryAllInferenceRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	7, // 3: inference.inference.QueryAllInferenceResponse.inference:type_name -> inference.inference.Inference
	9, // 4: inference.inference.QueryAllInferenceResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	0, // 5: inference.inference.Query.Params:input_type -> inference.inference.QueryParamsRequest
	2, // 6: inference.inference.Query.Inference:input_type -> inference.inference.QueryGetInferenceRequest
	4, // 7: inference.inference.Query.InferenceAll:input_type -> inference.inference.QueryAllInferenceRequest
	1, // 8: inference.inference.Query.Params:output_type -> inference.inference.QueryParamsResponse
	3, // 9: inference.inference.Query.Inference:output_type -> inference.inference.QueryGetInferenceResponse
	5, // 10: inference.inference.Query.InferenceAll:output_type -> inference.inference.QueryAllInferenceResponse
