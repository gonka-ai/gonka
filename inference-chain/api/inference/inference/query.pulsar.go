...
type QueryPocBatchesForStageResponse struct {
	...
	PocBatch []*PoCBatch `protobuf:"bytes,1,rep,name=pocBatch,proto3" json:"pocBatch,omitempty"`
}
...
func (x *QueryPocBatchesForStageResponse) GetPocBatch() []*PoCBatch {
	if x != nil {
		return x.PocBatch
	}
	return nil
...
var file_inference_inference_query_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x62, 0x0a, 0x1f, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x50, 0x6f, 0x63, 0x42, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x46, 0x6f,
	0x72, 0x53, 0x74, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f,
	...
	0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x08, 0x70, 0x6f, 0x63, 0x42, 0x61, 0x74, 0x63, 0x68, 0x32,
	0xa2, 0x0d, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x8f, 0x01, 0x0a, 0x06, 0x50, 0x61,
	...
	0x72, 0x12, 0xd0, 0x01, 0x0a, 0x12, 0x50, 0x6f, 0x63, 0x42, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73,
	...
	0x67, 0x68, 0x74, 0x7d, 0x42, 0xb8, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66,
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65,
...
var file_inference_inference_query_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_inference_inference_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                                  // 19: inference.inference.Params
	(*Inference)(nil),                               // 20: inference.inference.Inference
	...
	(*Participant)(nil),                             // 23: inference.inference.Participant
	(*PoCBatch)(nil),                                // 24: inference.inference.PoCBatch
}
var file_inference_inference_query_proto_depIdxs = []int32{
	19, // 0: inference.inference.QueryParamsResponse.params:type_name -> inference.inference.Params
	20, // 1: inference.inference.QueryGetInferenceResponse.inference:type_name -> inference.inference.Inference
	21, // 2: inference.inference.QueryAllInferenceRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	20, // 3: inference.inference.QueryAllInferenceResponse.inference:type_name -> inference.inference.Inference
	22, // 4: inference.inference.QueryAllInferenceResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	23, // 5: inference.inference.QueryGetParticipantResponse.participant:type_name -> inference.inference.Participant
	21, // 6: inference.inference.QueryAllParticipantRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	23, // 7: inference.inference.QueryAllParticipantResponse.participant:type_name -> inference.inference.Participant
	22, // 8: inference.inference.QueryAllParticipantResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	20, // 10: inference.inference.InferenceWithExecutor.inference:type_name -> inference.inference.Inference
	23, // 11: inference.inference.InferenceWithExecutor.executor:type_name -> inference.inference.Participant
	23, // 12: inference.inference.QueryGetRandomExecutorResponse.executor:type_name -> inference.inference.Participant
	24, // 13: inference.inference.QueryPocBatchesForStageResponse.pocBatch:type_name -> inference.inference.PoCBatch
	0,  // 14: inference.inference.Query.Params:input_type -> inference.inference.QueryParamsRequest
	2,  // 15: inference.inference.Query.Inference:input_type -> inference.inference.QueryGetInferenceRequest
	4,  // 16: inference.inference.Query.InferenceAll:input_type -> inference.inference.QueryAllInferenceRequest
	6,  // 17: inference.inference.Query.Participant:input_type -> inference.inference.QueryGetParticipantRequest
	8,  // 18: inference.inference.Query.ParticipantAll:input_type -> inference.inference.QueryAllParticipantRequest
	10, // 19: inference.inference.Query.GetInferencesWithExecutors:input_type -> inference.inference.QueryGetInferencesWithExecutorsRequest
	13, // 20: inference.inference.Query.InferenceParticipant:input_type -> inference.inference.QueryInferenceParticipantRequest
	15, // 21: inference.inference.Query.GetRandomExecutor:input_type -> inference.inference.QueryGetRandomExecutorRequest
	17, // 22: inference.inference.Query.PocBatchesForStage:input_type -> inference.inference.QueryPocBatchesForStageRequest
	1,  // 23: inference.inference.Query.Params:output_type -> inference.inference.QueryParamsResponse
	3,  // 24: inference.inference.Query.Inference:output_type -> inference.inference.QueryGetInferenceResponse
	5,  // 25: inference.inference.Query.InferenceAll:output_type -> inference.inference.QueryAllInferenceResponse
	7,  // 26: inference.inference.Query.Participant:output_type -> inference.inference.QueryGetParticipantResponse
	9,  // 27: inference.inference.Query.ParticipantAll:output_type -> inference.inference.QueryAllParticipantResponse
	11, // 28: inference.inference.Query.GetInferencesWithExecutors:output_type -> inference.inference.QueryGetInferencesWithExecutorsResponse
	14, // 29: inference.inference.Query.InferenceParticipant:output_type -> inference.inference.QueryInferenceParticipantResponse
	16, // 30: inference.inference.Query.GetRandomExecutor:output_type -> inference.inference.QueryGetRandomExecutorResponse
	18, // 31: inference.inference.Query.PocBatchesForStage:output_type -> inference.inference.QueryPocBatchesForStageResponse
