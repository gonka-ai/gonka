...
var (
	md_BridgeTradeApprovedToken                 protoreflect.MessageDescriptor
	fd_BridgeTradeApprovedToken_chainId         protoreflect.FieldDescriptor
	fd_BridgeTradeApprovedToken_contractAddress protoreflect.FieldDescriptor
)

func init() {
	file_inference_inference_bridge_proto_init()
	md_BridgeTradeApprovedToken = File_inference_inference_bridge_proto.Messages().ByName("BridgeTradeApprovedToken")
	fd_BridgeTradeApprovedToken_chainId = md_BridgeTradeApprovedToken.Fields().ByName("chainId")
	fd_BridgeTradeApprovedToken_contractAddress = md_BridgeTradeApprovedToken.Fields().ByName("contractAddress")
}

var _ protoreflect.Message = (*fastReflection_BridgeTradeApprovedToken)(nil)

type fastReflection_BridgeTradeApprovedToken BridgeTradeApprovedToken

func (x *BridgeTradeApprovedToken) ProtoReflect() protoreflect.Message {
	return (*fastReflection_BridgeTradeApprovedToken)(x)
}

func (x *BridgeTradeApprovedToken) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_BridgeTradeApprovedToken_messageType fastReflection_BridgeTradeApprovedToken_messageType
var _ protoreflect.MessageType = fastReflection_BridgeTradeApprovedToken_messageType{}

type fastReflection_BridgeTradeApprovedToken_messageType struct{}

func (x fastReflection_BridgeTradeApprovedToken_messageType) Zero() protoreflect.Message {
	return (*fastReflection_BridgeTradeApprovedToken)(nil)
}
func (x fastReflection_BridgeTradeApprovedToken_messageType) New() protoreflect.Message {
	return new(fastReflection_BridgeTradeApprovedToken)
}
func (x fastReflection_BridgeTradeApprovedToken_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_BridgeTradeApprovedToken
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_BridgeTradeApprovedToken) Descriptor() protoreflect.MessageDescriptor {
	return md_BridgeTradeApprovedToken
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_BridgeTradeApprovedToken) Type() protoreflect.MessageType {
	return _fastReflection_BridgeTradeApprovedToken_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_BridgeTradeApprovedToken) New() protoreflect.Message {
	return new(fastReflection_BridgeTradeApprovedToken)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_BridgeTradeApprovedToken) Interface() protoreflect.ProtoMessage {
	return (*BridgeTradeApprovedToken)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_BridgeTradeApprovedToken) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ChainId != "" {
		value := protoreflect.ValueOfString(x.ChainId)
		if !f(fd_BridgeTradeApprovedToken_chainId, value) {
			return
		}
	}
	if x.ContractAddress != "" {
		value := protoreflect.ValueOfString(x.ContractAddress)
		if !f(fd_BridgeTradeApprovedToken_contractAddress, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_BridgeTradeApprovedToken) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.inference.BridgeTradeApprovedToken.chainId":
		return x.ChainId != ""
	case "inference.inference.BridgeTradeApprovedToken.contractAddress":
		return x.ContractAddress != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.BridgeTradeApprovedToken"))
		}
		panic(fmt.Errorf("message inference.inference.BridgeTradeApprovedToken does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BridgeTradeApprovedToken) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "inference.inference.BridgeTradeApprovedToken.chainId":
		x.ChainId = ""
	case "inference.inference.BridgeTradeApprovedToken.contractAddress":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_BridgeTradeApprovedToken) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "inference.inference.BridgeTradeApprovedToken.chainId":
		value := x.ChainId
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message inference.inference.BridgeTradeApprovedToken does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BridgeTradeApprovedToken) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "inference.inference.BridgeTradeApprovedToken.chainId":
		x.ChainId = value.Interface().(string)
	case "inference.inference.BridgeTradeApprovedToken.contractAddress":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BridgeTradeApprovedToken) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.BridgeTradeApprovedToken.chainId":
		panic(fmt.Errorf("field chainId of message inference.inference.BridgeTradeApprovedToken is not mutable"))
	case "inference.inference.BridgeTradeApprovedToken.contractAddress":
		panic(fmt.Errorf("field contractAddress of message inference.inference.BridgeTradeApprovedToken is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.BridgeTradeApprovedToken"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_BridgeTradeApprovedToken) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "inference.inference.BridgeTradeApprovedToken.chainId":
		return protoreflect.ValueOfString("")
	case "inference.inference.BridgeTradeApprovedToken.contractAddress":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_BridgeTradeApprovedToken) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in inference.inference.BridgeTradeApprovedToken", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_BridgeTradeApprovedToken) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BridgeTradeApprovedToken) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_BridgeTradeApprovedToken) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_BridgeTradeApprovedToken) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*BridgeTradeApprovedToken)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: BridgeTradeApprovedToken: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: BridgeTradeApprovedToken: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *_Bridge_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*BridgeTradeApprovedToken)
	(*x.list)[i] = concreteValue
}
...
func (x *_Bridge_3_list) AppendMutable() protoreflect.Value {
	v := new(BridgeTradeApprovedToken)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}
...
func (x *fastReflection_Bridge) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.Bridge.trade_approved_tokens":
		if x.TradeApprovedTokens == nil {
			x.TradeApprovedTokens = []*BridgeTradeApprovedToken{}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				x.TradeApprovedTokens = append(x.TradeApprovedTokens, &BridgeTradeApprovedToken{})
...
func (x *BridgeTradeApprovedToken) Reset() {
	*x = BridgeTradeApprovedToken{}
	if protoimpl.UnsafeEnabled {
		mi := &file_inference_inference_bridge_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *BridgeTradeApprovedToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BridgeTradeApprovedToken) ProtoMessage() {}

// Deprecated: Use BridgeTradeApprovedToken.ProtoReflect.Descriptor instead.
func (*BridgeTradeApprovedToken) Descriptor() ([]byte, []int) {
	return file_inference_inference_bridge_proto_rawDescGZIP(), []int{2}
}

func (x *BridgeTradeApprovedToken) GetChainId() string {
	if x != nil {
		return x.ChainId
	}
	return ""
...
func (x *BridgeTradeApprovedToken) GetContractAddress() string {
	if x != nil {
		return x.ContractAddress
	}
	return ""
...
func (x *Bridge) GetTradeApprovedTokens() []*BridgeTradeApprovedToken {
	if x != nil {
...
var file_inference_inference_bridge_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x73, 0x22, 0x5e, 0x0a, 0x18, 0x42, 0x72, 0x69, 0x64,
	0x67, 0x65, 0x54, 0x72, 0x61, 0x64, 0x65, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x28,
	...
	0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xdd, 0x03, 0x0a, 0x11, 0x42, 0x72, 0x69,
	0x64, 0x67, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x18,
	0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x0f, 0x63, 0x6f, 0x6e, 0x74,
	...
	0x73, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x20,
	...
	,
	...
	,
	...
	,
...
var file_inference_inference_bridge_proto_goTypes = []interface{}{
	...
	(*BridgeTradeApprovedToken)(nil),   // 3: inference.inference.BridgeTradeApprovedToken
...
var file_inference_inference_bridge_proto_depIdxs = []int32{
	...
	3, // 3: inference.inference.Bridge.trade_approved_tokens:type_name -> inference.inference.BridgeTradeApprovedToken
...
func file_inference_inference_bridge_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_inference_inference_bridge_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BridgeTradeApprovedToken); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
