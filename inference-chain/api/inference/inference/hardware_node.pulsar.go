...
var (
	...
	fd_HardwareNode_training_port protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_HardwareNode_training_port = md_HardwareNode.Fields().ByName("training_port")
}
...
func (x *fastReflection_HardwareNode) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TrainingPort != "" {
		value := protoreflect.ValueOfString(x.TrainingPort)
		if !f(fd_HardwareNode_training_port, value) {
			return
		}
	}
}
...
func (x *fastReflection_HardwareNode) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.HardwareNode.host":
		return x.Host != ""
	case "inference.inference.HardwareNode.training_port":
		return x.TrainingPort != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_HardwareNode) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.HardwareNode.training_port":
		x.TrainingPort = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.HardwareNode"))
		}
...
func (x *fastReflection_HardwareNode) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.HardwareNode.training_port":
		panic(fmt.Errorf("field training_port of message inference.inference.HardwareNode is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.HardwareNode"))
		}
...
func (x *fastReflection_HardwareNode) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TrainingPort) > 0 {
			i -= len(x.TrainingPort)
			copy(dAtA[i:], x.TrainingPort)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TrainingPort)))
			i--
			dAtA[i] = 0x2a
		}
		if len(x.Host) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TrainingPort", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TrainingPort = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *HardwareNode) GetTrainingPort() string {
	if x != nil {
		return x.TrainingPort
	}
	return ""
...
var file_inference_inference_hardware_node_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0xde, 0x01, 0x0a, 0x0c,
	...
	0x61, 0x72, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x72, 0x61, 0x69, 0x6e,
	0x69, 0x6e, 0x67, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
	0x74, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x34, 0x0a, 0x08,
	0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	0x6e, 0x74, 0x2a, 0x47, 0x0a, 0x12, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x4e, 0x6f,
	0x64, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e,
	0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x49, 0x4e, 0x46, 0x45, 0x52, 0x45, 0x4e,
	0x43, 0x45, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4f, 0x43, 0x10, 0x02, 0x12, 0x0c, 0x0a,
	0x08, 0x54, 0x52, 0x41, 0x49, 0x4e, 0x49, 0x4e, 0x47, 0x10, 0x03, 0x42, 0xbf, 0x01, 0x0a, 0x17,
