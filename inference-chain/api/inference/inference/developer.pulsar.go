...
var _ protoreflect.Map = (*_DeveloperStatsByEpoch_2_map)(nil)

type _DeveloperStatsByEpoch_2_map struct {
	m *map[string]*InferenceStats
}

func (x *_DeveloperStatsByEpoch_2_map) Len() int {
	if x.m == nil {
		return 0
	}
	return len(*x.m)
...
func (x *_DeveloperStatsByEpoch_2_map) Range(f func(protoreflect.MapKey, protoreflect.Value) bool) {
	if x.m == nil {
		return
	}
	for k, v := range *x.m {
...
func (x *_DeveloperStatsByEpoch_2_map) Has(key protoreflect.MapKey) bool {
	if x.m == nil {
		return false
	}
...
func (x *_DeveloperStatsByEpoch_2_map) Clear(key protoreflect.MapKey) {
	if x.m == nil {
		return
	}
	keyUnwrapped := key.String()
...
func (x *_DeveloperStatsByEpoch_2_map) Get(key protoreflect.MapKey) protoreflect.Value {
	if x.m == nil {
...
func (x *_DeveloperStatsByEpoch_2_map) Set(key protoreflect.MapKey, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*InferenceStats)
	(*x.m)[concreteKey] = concreteValue
}

func (x *_DeveloperStatsByEpoch_2_map) Mutable(key protoreflect.MapKey) protoreflect.Value {
	keyUnwrapped := key.String()
	concreteKey := keyUnwrapped
	v, ok := (*x.m)[concreteKey]
	if ok {
	...
	newValue := new(InferenceStats)
	(*x.m)[concreteKey] = newValue
	return protoreflect.ValueOfMessage(newValue.ProtoReflect())
}

func (x *_DeveloperStatsByEpoch_2_map) NewValue() protoreflect.Value {
	v := new(InferenceStats)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_DeveloperStatsByEpoch_2_map) IsValid() bool {
	return x.m != nil
}
...
var (
	...
	fd_DeveloperStatsByEpoch_inferences protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_DeveloperStatsByEpoch_inferences = md_DeveloperStatsByEpoch.Fields().ByName("inferences")
}
...
func (x *fastReflection_DeveloperStatsByEpoch) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Inferences) != 0 {
		value := protoreflect.ValueOfMap(&_DeveloperStatsByEpoch_2_map{m: &x.Inferences})
		if !f(fd_DeveloperStatsByEpoch_inferences, value) {
			return
		}
	}
}
...
func (x *fastReflection_DeveloperStatsByEpoch) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.DeveloperStatsByEpoch.inferences":
...
func (x *fastReflection_DeveloperStatsByEpoch) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.DeveloperStatsByEpoch.inferences":
		if len(x.Inferences) == 0 {
			return protoreflect.ValueOfMap(&_DeveloperStatsByEpoch_2_map{})
		}
		mapValue := &_DeveloperStatsByEpoch_2_map{m: &x.Inferences}
...
func (x *fastReflection_DeveloperStatsByEpoch) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.DeveloperStatsByEpoch.inferences":
		mv := value.Map()
		cmv := mv.(*_DeveloperStatsByEpoch_2_map)
		x.Inferences = *cmv.m
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.DeveloperStatsByEpoch"))
...
func (x *fastReflection_DeveloperStatsByEpoch) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.DeveloperStatsByEpoch.inferences":
		if x.Inferences == nil {
			x.Inferences = make(map[string]*InferenceStats)
		}
		value := &_DeveloperStatsByEpoch_2_map{m: &x.Inferences}
...
func (x *fastReflection_DeveloperStatsByEpoch) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.DeveloperStatsByEpoch.inferences":
		m := make(map[string]*InferenceStats)
		return protoreflect.ValueOfMap(&_DeveloperStatsByEpoch_2_map{m: &m})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.DeveloperStatsByEpoch"))
		}
...
func (x *fastReflection_DeveloperStatsByEpoch) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.Inferences) > 0 {
			SiZeMaP := func(k string, v *InferenceStats) {
				l := 0
				if v != nil {
					l = options.Size(v)
				}
			...
			if options.Deterministic {
				sortme := make([]string, 0, len(x.Inferences))
				for k := range x.Inferences {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Inferences) > 0 {
			MaRsHaLmAp := func(k string, v *InferenceStats) (protoiface.MarshalOutput, error) {
				baseI := i
			...
			if options.Deterministic {
				keysForInferences := make([]string, 0, len(x.Inferences))
				for k := range x.Inferences {
					keysForInferences = append(keysForInferences, string(k))
				}
				sort.Slice(keysForInferences, func(i, j int) bool {
					return keysForInferences[i] < keysForInferences[j]
				})
				for iNdEx := len(keysForInferences) - 1; iNdEx >= 0; iNdEx-- {
					v := x.Inferences[string(keysForInferences[iNdEx])]
					out, err := MaRsHaLmAp(keysForInferences[iNdEx], v)
					if err != nil {
						return out, err
					}
				}
...
var (
	...
	fd_InferenceStats_epoch_poc_block_height protoreflect.FieldDescriptor
	fd_InferenceStats_status                 protoreflect.FieldDescriptor
	fd_InferenceStats_ai_tokens_used         protoreflect.FieldDescriptor
	fd_InferenceStats_model                  protoreflect.FieldDescriptor
	fd_InferenceStats_actual_const_in_coins  protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_InferenceStats_epoch_poc_block_height = md_InferenceStats.Fields().ByName("epoch_poc_block_height")
	fd_InferenceStats_status = md_InferenceStats.Fields().ByName("status")
	fd_InferenceStats_ai_tokens_used = md_InferenceStats.Fields().ByName("ai_tokens_used")
	fd_InferenceStats_model = md_InferenceStats.Fields().ByName("model")
	fd_InferenceStats_actual_const_in_coins = md_InferenceStats.Fields().ByName("actual_const_in_coins")
}
...
func (x *fastReflection_InferenceStats) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EpochPocBlockHeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.EpochPocBlockHeight)
		if !f(fd_InferenceStats_epoch_poc_block_height, value) {
			return
		}
	}
	if x.Status != 0 {
	...
	if x.AiTokensUsed != uint64(0) {
		value := protoreflect.ValueOfUint64(x.AiTokensUsed)
		if !f(fd_InferenceStats_ai_tokens_used, value) {
			return
		}
	}
	if x.Model != "" {
	...
	if x.ActualConstInCoins != int64(0) {
		value := protoreflect.ValueOfInt64(x.ActualConstInCoins)
		if !f(fd_InferenceStats_actual_const_in_coins, value) {
			return
		}
	}
}
...
func (x *fastReflection_InferenceStats) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.InferenceStats.epoch_poc_block_height":
		return x.EpochPocBlockHeight != uint64(0)
	case "inference.inference.InferenceStats.status":
		return x.Status != 0
	case "inference.inference.InferenceStats.ai_tokens_used":
		return x.AiTokensUsed != uint64(0)
	case "inference.inference.InferenceStats.model":
		return x.Model != ""
	case "inference.inference.InferenceStats.actual_const_in_coins":
		return x.ActualConstInCoins != int64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_InferenceStats) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "inference.inference.InferenceStats.inference_id":
		x.InferenceId = ""
	case "inference.inference.InferenceStats.epoch_poc_block_height":
		x.EpochPocBlockHeight = uint64(0)
	case "inference.inference.InferenceStats.status":
		x.Status = 0
	case "inference.inference.InferenceStats.ai_tokens_used":
		x.AiTokensUsed = uint64(0)
	case "inference.inference.InferenceStats.model":
		x.Model = ""
	case "inference.inference.InferenceStats.actual_const_in_coins":
		x.ActualConstInCoins = int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.InferenceStats"))
		}
...
func (x *fastReflection_InferenceStats) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.InferenceStats.epoch_poc_block_height":
		value := x.EpochPocBlockHeight
		return protoreflect.ValueOfUint64(value)
	case "inference.inference.InferenceStats.status":
		value := x.Status
		return protoreflect.ValueOfEnum((protoreflect.EnumNumber)(value))
	case "inference.inference.InferenceStats.ai_tokens_used":
		value := x.AiTokensUsed
		return protoreflect.ValueOfUint64(value)
	case "inference.inference.InferenceStats.model":
		value := x.Model
		return protoreflect.ValueOfString(value)
	case "inference.inference.InferenceStats.actual_const_in_coins":
		value := x.ActualConstInCoins
...
func (x *fastReflection_InferenceStats) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.InferenceStats.epoch_poc_block_height":
		x.EpochPocBlockHeight = value.Uint()
	case "inference.inference.InferenceStats.status":
		x.Status = (InferenceStatus)(value.Enum())
	case "inference.inference.InferenceStats.ai_tokens_used":
		x.AiTokensUsed = value.Uint()
	case "inference.inference.InferenceStats.model":
		x.Model = value.Interface().(string)
	case "inference.inference.InferenceStats.actual_const_in_coins":
		x.ActualConstInCoins = value.Int()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.InferenceStats"))
		}
...
func (x *fastReflection_InferenceStats) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.InferenceStats.epoch_poc_block_height":
		panic(fmt.Errorf("field epoch_poc_block_height of message inference.inference.InferenceStats is not mutable"))
	case "inference.inference.InferenceStats.status":
		panic(fmt.Errorf("field status of message inference.inference.InferenceStats is not mutable"))
	case "inference.inference.InferenceStats.ai_tokens_used":
		panic(fmt.Errorf("field ai_tokens_used of message inference.inference.InferenceStats is not mutable"))
	case "inference.inference.InferenceStats.model":
		panic(fmt.Errorf("field model of message inference.inference.InferenceStats is not mutable"))
	case "inference.inference.InferenceStats.actual_const_in_coins":
		panic(fmt.Errorf("field actual_const_in_coins of message inference.inference.InferenceStats is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.InferenceStats"))
		}
...
func (x *fastReflection_InferenceStats) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.EpochPocBlockHeight != 0 {
			n += 1 + runtime.Sov(uint64(x.EpochPocBlockHeight))
		}
		if x.Status != 0 {
			n += 1 + runtime.Sov(uint64(x.Status))
		}
		if x.AiTokensUsed != 0 {
			n += 1 + runtime.Sov(uint64(x.AiTokensUsed))
		}
		l = len(x.Model)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.ActualConstInCoins != 0 {
			n += 1 + runtime.Sov(uint64(x.ActualConstInCoins))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ActualConstInCoins != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.ActualConstInCoins))
			i--
			dAtA[i] = 0x30
		}
		if len(x.Model) > 0 {
		...
		if x.AiTokensUsed != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.AiTokensUsed))
			i--
			dAtA[i] = 0x20
		}
		if x.Status != 0 {
		...
		if x.EpochPocBlockHeight != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.EpochPocBlockHeight))
			i--
			dAtA[i] = 0x10
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EpochPocBlockHeight", wireType)
				}
				x.EpochPocBlockHeight = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.EpochPocBlockHeight |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			...
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AiTokensUsed", wireType)
				}
				x.AiTokensUsed = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.AiTokensUsed |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			...
			case 6:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ActualConstInCoins", wireType)
				}
				x.ActualConstInCoins = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.ActualConstInCoins |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *DeveloperStatsByEpoch) GetInferences() map[string]*InferenceStats {
	if x != nil {
		return x.Inferences
	}
	return nil
...
func (x *InferenceStats) GetEpochPocBlockHeight() uint64 {
	if x != nil {
		return x.EpochPocBlockHeight
	}
	return 0
}
...
func (x *InferenceStats) GetAiTokensUsed() uint64 {
	if x != nil {
...
func (x *InferenceStats) GetActualConstInCoins() int64 {
	if x != nil {
		return x.ActualConstInCoins
	}
	return 0
}
...
var file_inference_inference_developer_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x0a, 0x09, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x09, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	0x65, 0x42, 0xbc, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x0e, 0x44,
	0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
...
var file_inference_inference_developer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_inference_inference_developer_proto_goTypes = []interface{}{
	...
	nil,                           // 3: inference.inference.DeveloperStatsByEpoch.InferencesEntry
	(InferenceStatus)(0),          // 4: inference.inference.InferenceStatus
}
var file_inference_inference_developer_proto_depIdxs = []int32{
	3, // 0: inference.inference.DeveloperStatsByEpoch.inferences:type_name -> inference.inference.DeveloperStatsByEpoch.InferencesEntry
	4, // 1: inference.inference.InferenceStats.status:type_name -> inference.inference.InferenceStatus
	1, // 2: inference.inference.DeveloperStatsByTime.inference:type_name -> inference.inference.InferenceStats
	1, // 3: inference.inference.DeveloperStatsByEpoch.InferencesEntry.value:type_name -> inference.inference.InferenceStats
