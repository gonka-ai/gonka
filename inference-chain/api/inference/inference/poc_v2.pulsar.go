...
var (
	...
	fd_PoCV2StoreCommit_tree_depth                   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PoCV2StoreCommit_tree_depth = md_PoCV2StoreCommit.Fields().ByName("tree_depth")
}
...
func (x *fastReflection_PoCV2StoreCommit) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TreeDepth != uint32(0) {
		value := protoreflect.ValueOfUint32(x.TreeDepth)
		if !f(fd_PoCV2StoreCommit_tree_depth, value) {
			return
		}
	}
}
...
func (x *fastReflection_PoCV2StoreCommit) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.PoCV2StoreCommit.model_id":
		return x.ModelId != ""
	case "inference.inference.PoCV2StoreCommit.tree_depth":
		return x.TreeDepth != uint32(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_PoCV2StoreCommit) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.PoCV2StoreCommit.tree_depth":
		panic(fmt.Errorf("field tree_depth of message inference.inference.PoCV2StoreCommit is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.PoCV2StoreCommit"))
		}
...
func (x *fastReflection_PoCV2StoreCommit) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.TreeDepth != 0 {
			n += 1 + runtime.Sov(uint64(x.TreeDepth))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TreeDepth != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.TreeDepth))
			i--
			dAtA[i] = 0x38
		}
		if len(x.ModelId) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TreeDepth", wireType)
				}
				x.TreeDepth = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.TreeDepth |= uint32(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
var (
	...
	fd_PoCV2CommitEntry_tree_depth protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PoCV2CommitEntry_tree_depth = md_PoCV2CommitEntry.Fields().ByName("tree_depth")
}
...
func (x *fastReflection_PoCV2CommitEntry) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TreeDepth != uint32(0) {
		value := protoreflect.ValueOfUint32(x.TreeDepth)
		if !f(fd_PoCV2CommitEntry_tree_depth, value) {
			return
		}
	}
}
...
func (x *fastReflection_PoCV2CommitEntry) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.PoCV2CommitEntry.root_hash":
		return len(x.RootHash) != 0
	case "inference.inference.PoCV2CommitEntry.tree_depth":
		return x.TreeDepth != uint32(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_PoCV2CommitEntry) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.PoCV2CommitEntry.tree_depth":
		panic(fmt.Errorf("field tree_depth of message inference.inference.PoCV2CommitEntry is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.PoCV2CommitEntry"))
		}
...
func (x *PoCV2StoreCommit) GetTreeDepth() uint32 {
	if x != nil {
		return x.TreeDepth
	}
	return 0
...
func (x *PoCV2CommitEntry) GetTreeDepth() uint32 {
	if x != nil {
		return x.TreeDepth
	}
	return 0
...
var file_inference_inference_poc_v2_proto_rawDesc = []byte{
	...
	0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xa0, 0x02, 0x0a, 0x10, 0x50, 0x6f, 0x43, 0x56, 0x32,
	...
	0x09, 0x52, 0x07, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x72,
	0x65, 0x65, 0x5f, 0x64, 0x65, 0x70, 0x74, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09,
	0x74, 0x72, 0x65, 0x65, 0x44, 0x65, 0x70, 0x74, 0x68, 0x22, 0x7f, 0x0a, 0x10, 0x50, 0x6f, 0x43,
	0x56, 0x32, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x19, 0x0a,
	0x08, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x0c, 0x52, 0x08, 0x72, 0x6f, 0x6f, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x74,
	0x72, 0x65, 0x65, 0x5f, 0x64, 0x65, 0x70, 0x74, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x09, 0x74, 0x72, 0x65, 0x65, 0x44, 0x65, 0x70, 0x74, 0x68, 0x22, 0xe3, 0x01, 0x0a, 0x18, 0x4d,
	...
	,
