...
var _ protoreflect.List = (*_BridgeTransaction_12_list)(nil)

type _BridgeTransaction_12_list struct {
	list *[]string
}

func (x *_BridgeTransaction_12_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_BridgeTransaction_12_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_BridgeTransaction_12_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_BridgeTransaction_12_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_BridgeTransaction_12_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message BridgeTransaction at list field ApprovedBy as it is not of Message kind"))
}

func (x *_BridgeTransaction_12_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_BridgeTransaction_12_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_BridgeTransaction_12_list) IsValid() bool {
	return x.list != nil
}

var (
	md_BridgeTransaction                 protoreflect.MessageDescriptor
	fd_BridgeTransaction_index           protoreflect.FieldDescriptor
	...
	fd_BridgeTransaction_approvedBy      protoreflect.FieldDescriptor
...
func init() {
	...
	fd_BridgeTransaction_index = md_BridgeTransaction.Fields().ByName("index")
	...
	fd_BridgeTransaction_approvedBy = md_BridgeTransaction.Fields().ByName("approvedBy")
...
func (x *fastReflection_BridgeTransaction) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Index != "" {
		...
		if !f(fd_BridgeTransaction_index, value) {
			return
		}
	}
	if x.OriginChain != "" {
	...
	if len(x.ApprovedBy) != 0 {
		value := protoreflect.ValueOfList(&_BridgeTransaction_12_list{list: &x.ApprovedBy})
		if !f(fd_BridgeTransaction_approvedBy, value) {
			return
		}
	}
	if x.BlockNumber != "" {
...
func (x *fastReflection_BridgeTransaction) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "inference.inference.BridgeTransaction.index":
		return x.Index != ""
	...
	case "inference.inference.BridgeTransaction.approvedBy":
		return len(x.ApprovedBy) != 0
...
func (x *fastReflection_BridgeTransaction) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.BridgeTransaction.approvedBy":
		if len(x.ApprovedBy) == 0 {
			return protoreflect.ValueOfList(&_BridgeTransaction_12_list{})
		}
		listValue := &_BridgeTransaction_12_list{list: &x.ApprovedBy}
		return protoreflect.ValueOfList(listValue)
	case "inference.inference.BridgeTransaction.blockNumber":
		value := x.BlockNumber
		return protoreflect.ValueOfString(value)
...
func (x *fastReflection_BridgeTransaction) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.BridgeTransaction.approvedBy":
		lv := value.List()
		clv := lv.(*_BridgeTransaction_12_list)
		x.ApprovedBy = *clv.list
	case "inference.inference.BridgeTransaction.blockNumber":
...
func (x *fastReflection_BridgeTransaction) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.BridgeTransaction.approvedBy":
		...
		value := &_BridgeTransaction_12_list{list: &x.ApprovedBy}
		return protoreflect.ValueOfList(value)
	case "inference.inference.BridgeTransaction.index":
		panic(fmt.Errorf("field index of message inference.inference.BridgeTransaction is not mutable"))
	case "inference.inference.BridgeTransaction.originChain":
...
func (x *fastReflection_BridgeTransaction) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.BridgeTransaction.approvedBy":
		list := []string{}
		return protoreflect.ValueOfList(&_BridgeTransaction_12_list{list: &list})
	case "inference.inference.BridgeTransaction.blockNumber":
		return protoreflect.ValueOfString("")
	case "inference.inference.BridgeTransaction.receiptIndex":
		return protoreflect.ValueOfString("")
...
func (x *fastReflection_BridgeTransaction) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ApprovedBy) > 0 {
			for iNdEx := len(x.ApprovedBy) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.ApprovedBy[iNdEx])
				copy(dAtA[i:], x.ApprovedBy[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ApprovedBy[iNdEx])))
				i--
				dAtA[i] = 0x62
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 12:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ApprovedBy", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ApprovedBy = append(x.ApprovedBy, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 13:
				if wireType != 2 {
...
type BridgeTransaction struct {
	...
	BlockNumber     string                  `protobuf:"bytes,13,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`   // block number where the transaction occurred on the origin chain
	ReceiptIndex    string                  `protobuf:"bytes,14,opt,name=receiptIndex,proto3" json:"receiptIndex,omitempty"` // index of the transaction receipt in the block
	ReceiptsRoot    string                  `protobuf:"bytes,15,opt,name=receiptsRoot,proto3" json:"receiptsRoot,omitempty"` // merkle root of receipts trie for transaction verification
}
...
func (x *BridgeTransaction) GetIndex() string {
	if x != nil {
		return x.Index
	}
	return ""
...
func (x *BridgeTransaction) GetApprovedBy() []string {
	if x != nil {
		return x.ApprovedBy
	}
	return nil
...
var file_inference_inference_bridge_transaction_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x65, 0x22, 0xa9, 0x04, 0x0a, 0x11, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64,
	0x65, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12,
	0x20, 0x0a, 0x0b, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x18, 0x02,
	...
	0x72, 0x61, 0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x6f,
	...
	0x70, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65,
	...
	,
	...
	0x45, 0x44, 0x10, 0x01, 0x42, 0xc4, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66,
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65,
	0x42, 0x16, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x24, 0x63, 0x6f, 0x73, 0x6d,
