...
var (
	...
	fd_EpochGroupValidations_poc_start_block_height protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EpochGroupValidations_poc_start_block_height = md_EpochGroupValidations.Fields().ByName("poc_start_block_height")
...
func (x *fastReflection_EpochGroupValidations) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PocStartBlockHeight != uint64(0) {
		...
		if !f(fd_EpochGroupValidations_poc_start_block_height, value) {
			return
		}
	}
...
func (x *fastReflection_EpochGroupValidations) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.EpochGroupValidations.poc_start_block_height":
...
func (x *fastReflection_EpochGroupValidations) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupValidations.poc_start_block_height":
		panic(fmt.Errorf("field poc_start_block_height of message inference.inference.EpochGroupValidations is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.EpochGroupValidations"))
		}
...
var file_inference_inference_epoch_group_validations_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0xa1, 0x01, 0x0a, 0x15, 0x45, 0x70, 0x6f,
	...
	0x70, 0x61, 0x6e, 0x74, 0x12, 0x33, 0x0a, 0x16, 0x70, 0x6f, 0x63, 0x5f, 0x73, 0x74, 0x61, 0x72,
	...
	0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x31, 0x0a, 0x14, 0x76, 0x61, 0x6c,
	0x69, 0x64, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x13, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x65, 0x64, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x42, 0xc8, 0x01, 0x0a,
	0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69,
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x1a, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x50,
