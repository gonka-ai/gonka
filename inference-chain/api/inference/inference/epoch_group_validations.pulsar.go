...
var (
	...
	fd_EpochGroupValidations_pocStartBlockHeight protoreflect.FieldDescriptor
	fd_EpochGroupValidations_validatedInferences protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EpochGroupValidations_pocStartBlockHeight = md_EpochGroupValidations.Fields().ByName("pocStartBlockHeight")
	fd_EpochGroupValidations_validatedInferences = md_EpochGroupValidations.Fields().ByName("validatedInferences")
}
...
func (x *fastReflection_EpochGroupValidations) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.EpochGroupValidations.pocStartBlockHeight":
		return x.PocStartBlockHeight != uint64(0)
	case "inference.inference.EpochGroupValidations.validatedInferences":
...
func (x *fastReflection_EpochGroupValidations) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.EpochGroupValidations.pocStartBlockHeight":
		panic(fmt.Errorf("field pocStartBlockHeight of message inference.inference.EpochGroupValidations is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.EpochGroupValidations"))
		}
...
func (x *EpochGroupValidations) GetPocStartBlockHeight() uint64 {
	if x != nil {
...
var file_inference_inference_epoch_group_validations_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x9d, 0x01, 0x0a, 0x15, 0x45, 0x70, 0x6f,
	...
	0x70, 0x61, 0x6e, 0x74, 0x12, 0x30, 0x0a, 0x13, 0x70, 0x6f, 0x63, 0x53, 0x74, 0x61, 0x72, 0x74,
	...
	0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x30, 0x0a, 0x13, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x64, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20,
