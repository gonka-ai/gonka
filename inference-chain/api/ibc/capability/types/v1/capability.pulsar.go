...
func init() {
	file_ibc_capability_types_v1_capability_proto_init()
	md_Capability = File_ibc_capability_types_v1_capability_proto.Messages().ByName("Capability")
...
func (x *Capability) slowProtoReflect() protoreflect.Message {
	mi := &file_ibc_capability_types_v1_capability_proto_msgTypes[0]
...
func (x *fastReflection_Capability) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ibc.capability.types.v1.Capability.index":
		return x.Index != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ibc.capability.types.v1.Capability"))
		}
		panic(fmt.Errorf("message ibc.capability.types.v1.Capability does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Capability) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ibc.capability.types.v1.Capability does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Capability) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ibc.capability.types.v1.Capability.index":
		panic(fmt.Errorf("field index of message ibc.capability.types.v1.Capability is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ibc.capability.types.v1.Capability"))
		}
...
func (x *fastReflection_Capability) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ibc.capability.types.v1.Capability", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_ibc_capability_types_v1_capability_proto_init()
	md_Owner = File_ibc_capability_types_v1_capability_proto.Messages().ByName("Owner")
...
func (x *Owner) slowProtoReflect() protoreflect.Message {
	mi := &file_ibc_capability_types_v1_capability_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Owner) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ibc.capability.types.v1.Owner.module":
		return x.Module != ""
	case "ibc.capability.types.v1.Owner.name":
		return x.Name != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ibc.capability.types.v1.Owner"))
		}
		panic(fmt.Errorf("message ibc.capability.types.v1.Owner does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Owner) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ibc.capability.types.v1.Owner does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Owner) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ibc.capability.types.v1.Owner.module":
		panic(fmt.Errorf("field module of message ibc.capability.types.v1.Owner is not mutable"))
	case "ibc.capability.types.v1.Owner.name":
		panic(fmt.Errorf("field name of message ibc.capability.types.v1.Owner is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ibc.capability.types.v1.Owner"))
		}
...
func (x *fastReflection_Owner) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ibc.capability.types.v1.Owner", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_ibc_capability_types_v1_capability_proto_init()
	md_CapabilityOwners = File_ibc_capability_types_v1_capability_proto.Messages().ByName("CapabilityOwners")
...
func (x *CapabilityOwners) slowProtoReflect() protoreflect.Message {
	mi := &file_ibc_capability_types_v1_capability_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CapabilityOwners) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ibc.capability.types.v1.CapabilityOwners.owners":
		return len(x.Owners) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ibc.capability.types.v1.CapabilityOwners"))
		}
		panic(fmt.Errorf("message ibc.capability.types.v1.CapabilityOwners does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CapabilityOwners) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ibc.capability.types.v1.CapabilityOwners does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CapabilityOwners) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ibc.capability.types.v1.CapabilityOwners", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: ibc/capability/types/v1/capability.proto
...
func (*Capability) Descriptor() ([]byte, []int) {
	return file_ibc_capability_types_v1_capability_proto_rawDescGZIP(), []int{0}
}
...
func (*Owner) Descriptor() ([]byte, []int) {
	return file_ibc_capability_types_v1_capability_proto_rawDescGZIP(), []int{1}
}
...
func (*CapabilityOwners) Descriptor() ([]byte, []int) {
	return file_ibc_capability_types_v1_capability_proto_rawDescGZIP(), []int{2}
}
...
var File_ibc_capability_types_v1_capability_proto protoreflect.FileDescriptor

var file_ibc_capability_types_v1_capability_proto_rawDesc = []byte{
	0x0a, 0x28, 0x69, 0x62, 0x63, 0x2f, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17, 0x69, 0x62, 0x63, 0x2e,
	0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	...
	0x2f, 0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x28, 0x0a, 0x0a,
	...
	0x3a, 0x04, 0x98, 0xa0, 0x1f, 0x00, 0x22, 0x3d, 0x0a, 0x05, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x12,
	...
	,
	...
	,
}

var (
	file_ibc_capability_types_v1_capability_proto_rawDescOnce sync.Once
	file_ibc_capability_types_v1_capability_proto_rawDescData = file_ibc_capability_types_v1_capability_proto_rawDesc
)

func file_ibc_capability_types_v1_capability_proto_rawDescGZIP() []byte {
	file_ibc_capability_types_v1_capability_proto_rawDescOnce.Do(func() {
		file_ibc_capability_types_v1_capability_proto_rawDescData = protoimpl.X.CompressGZIP(file_ibc_capability_types_v1_capability_proto_rawDescData)
	})
	return file_ibc_capability_types_v1_capability_proto_rawDescData
}

var file_ibc_capability_types_v1_capability_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_ibc_capability_types_v1_capability_proto_goTypes = []interface{}{
	(*Capability)(nil),       // 0: ibc.capability.types.v1.Capability
	(*Owner)(nil),            // 1: ibc.capability.types.v1.Owner
	(*CapabilityOwners)(nil), // 2: ibc.capability.types.v1.CapabilityOwners
}
var file_ibc_capability_types_v1_capability_proto_depIdxs = []int32{
	1, // 0: ibc.capability.types.v1.CapabilityOwners.owners:type_name -> ibc.capability.types.v1.Owner
...
func init() { file_ibc_capability_types_v1_capability_proto_init() }
func file_ibc_capability_types_v1_capability_proto_init() {
	if File_ibc_capability_types_v1_capability_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ibc_capability_types_v1_capability_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ibc_capability_types_v1_capability_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
		...
		file_ibc_capability_types_v1_capability_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ibc_capability_types_v1_capability_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ibc_capability_types_v1_capability_proto_goTypes,
		DependencyIndexes: file_ibc_capability_types_v1_capability_proto_depIdxs,
		MessageInfos:      file_ibc_capability_types_v1_capability_proto_msgTypes,
	}.Build()
	File_ibc_capability_types_v1_capability_proto = out.File
	file_ibc_capability_types_v1_capability_proto_rawDesc = nil
	file_ibc_capability_types_v1_capability_proto_goTypes = nil
	file_ibc_capability_types_v1_capability_proto_depIdxs = nil
}
