...
# update genesis
$INFERENCED_BIN genesis add-genesis-account alice 10000000mini --keyring-backend test
$INFERENCED_BIN genesis add-genesis-account bob 1000mini --keyring-backend test
# create default validator
$INFERENCED_BIN genesis gentx alice 1000000mini --chain-id demo
