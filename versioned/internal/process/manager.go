...
// published in the route table. Consensus permanently binds a version name to
// its SHA, so a later catalog can change a mirror URL but cannot redefine the
// artifact identity behind an admitted route.
