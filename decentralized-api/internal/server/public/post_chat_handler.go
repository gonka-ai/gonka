...
func (s *Server) getAllowedPubKeysForInferenceRequests(ctx echo.Context, granterAddress string) ([]string, error) {
...
func (s *Server) validateFullRequest(ctx echo.Context, request *ChatRequest) error {
	...
	transferPubkeys, err := s.getAllowedPubKeysForInferenceRequests(ctx, request.TransferAddress)
	if err != nil {
