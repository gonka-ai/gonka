...
func TestProcessExecutionHTTPResponse_PartialSSEAfterInterruption(t *testing.T) {
	...
	require.Equal(t, "partial_response_after_interruption", processed.PartialResponseReason)
	require.Equal(t, "runtime.process_execution_response", processed.PartialResponseWhere)
