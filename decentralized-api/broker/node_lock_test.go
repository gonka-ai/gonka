...
func TestAcquireMLNode_ReturnsLockAndEndpoint(t *testing.T) {
	...
	lockID, endpoint, err := b.AcquireMLNode(context.Background(), "model1", nil)
...
func TestAcquireMLNode_NoNodes(t *testing.T) {
	...
	_, _, err := b.AcquireMLNode(context.Background(), "model1", nil)
...
func TestAcquireMLNode_Concurrency(t *testing.T) {
	...
	lockID, _, err := b.AcquireMLNode(context.Background(), "model1", nil)
	require.NoError(t, err)
...
func TestReleaseMLNode_NodeBecomesAvailableAgain(t *testing.T) {
	...
	lockID2, _, err := b.AcquireMLNode(context.Background(), "model1", nil)
	require.NoError(t, err)
