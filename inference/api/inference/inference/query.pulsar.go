...
var file_inference_inference_query_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x73, 0x42, 0xb8, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66,
...
var file_inference_inference_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_inference_inference_query_proto_depIdxs = []int32{
	2, // 0: inference.inference.QueryParamsResponse.params:type_name -> inference.inference.Params
	0, // 1: inference.inference.Query.Params:input_type -> inference.inference.QueryParamsRequest
	1, // 2: inference.inference.Query.Params:output_type -> inference.inference.QueryParamsResponse
