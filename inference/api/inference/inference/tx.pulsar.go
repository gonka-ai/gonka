...
var file_inference_inference_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_inference_inference_tx_proto_depIdxs = []int32{
	2, // 0: inference.inference.MsgUpdateParams.params:type_name -> inference.inference.Params
	0, // 1: inference.inference.Msg.UpdateParams:input_type -> inference.inference.MsgUpdateParams
	1, // 2: inference.inference.Msg.UpdateParams:output_type -> inference.inference.MsgUpdateParamsResponse
