...
var file_inference_inference_tx_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x32, 0xda,
...
var file_inference_inference_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_inference_inference_tx_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                    // 4: inference.inference.Params
}
var file_inference_inference_tx_proto_depIdxs = []int32{
	4, // 0: inference.inference.MsgUpdateParams.params:type_name -> inference.inference.Params
	...
	1, // 3: inference.inference.Msg.UpdateParams:output_type -> inference.inference.MsgUpdateParamsResponse
	3, // 4: inference.inference.Msg.StartInference:output_type -> inference.inference.MsgStartInferenceResponse
