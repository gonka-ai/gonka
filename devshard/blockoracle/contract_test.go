...
// TestBlockOracleInterfaceGolden records the BlockOracle method set. Any
// change requires updating testdata/blockoracle_interface_golden.txt (and
// corresponding decentralized-api / consumer review); see
// devshard/docs/testenv.md §8.4 item 5.
func TestBlockOracleInterfaceGolden(t *testing.T) {
	...
	goldenPath := filepath.Join(dir, "testdata", "blockoracle_interface_golden.txt")
