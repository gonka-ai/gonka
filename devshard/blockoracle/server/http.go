...
//	GET /healthz
//
// The handlers JSON-encode blockoracle.Header byte-for-byte stable across
...
// blockoracle/client.
func Mount(g *echo.Group, oracle blockoracle.BlockOracle) {
	if g == nil {
...
func handleLatest(oracle blockoracle.BlockOracle) echo.HandlerFunc {
...
func handleAt(oracle blockoracle.BlockOracle) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func handleProve(oracle blockoracle.BlockOracle) echo.HandlerFunc {
	return func(c echo.Context) error {
		height, err := parseHeight(c.Param("height"))
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, err.Error())
...
func handleStream(oracle blockoracle.BlockOracle) echo.HandlerFunc {
	return func(c echo.Context) error {
		from := int64(0)
