...
func TestStatsShardDetailResolvesO1WithoutListScan(t *testing.T) {
	...
	require.Equal(t, http.StatusOK, rec.Code, "body: %s", rec.Body.String())
	require.Equal(t, int32(0), counting.listCalls.Load(), "detail must not ListActiveSessions")
	require.Equal(t, int32(1), counting.metaCalls.Load(), "detail should GetSessionMeta once")
}
...
func TestStatsShardDetailNegativeCacheSkipsStoreOnRepeatMiss(t *testing.T) {
	...
	require.Equal(t, int32(0), counting.listCalls.Load())
	require.Equal(t, int32(1), counting.metaCalls.Load())
	...
	require.Equal(t, int32(0), counting.listCalls.Load())
	require.Equal(t, int32(1), counting.metaCalls.Load(), "negative cache must skip GetSessionMeta on repeat miss")
}
...
func TestStatsShardDetailNegativeCacheForVersionMismatch(t *testing.T) {
	...
	require.Equal(t, int32(1), counting.metaCalls.Load(), "version mismatch should be negatively cached")
}
...
func TestStatsShardDetailSkipsSettledSession(t *testing.T) {
	...
	require.Equal(t, http.StatusNotFound, rec2.Code)
	require.Equal(t, int32(1), counting.metaCalls.Load(), "settled miss should be negatively cached")
}
