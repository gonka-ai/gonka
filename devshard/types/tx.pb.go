...
const (
	...
	FinishReason_FINISH_REASON_COMPLETED                  FinishReason = 1
	FinishReason_FINISH_REASON_DEVSHARD_REQUESTS_DISABLED FinishReason = 2
	FinishReason_FINISH_REASON_POC_ABORTED                FinishReason = 3
	FinishReason_FINISH_REASON_NO_PRESERVE_NODES          FinishReason = 4
)
...
var (
	FinishReason_name = map[int32]string{
		...
		1: "FINISH_REASON_COMPLETED",
		2: "FINISH_REASON_DEVSHARD_REQUESTS_DISABLED",
		3: "FINISH_REASON_POC_ABORTED",
		4: "FINISH_REASON_NO_PRESERVE_NODES",
	}
...
func (FinishReason) Descriptor() protoreflect.EnumDescriptor {
	return file_devshard_v1_tx_proto_enumTypes[1].Descriptor()
}

func (FinishReason) Type() protoreflect.EnumType {
	return &file_devshard_v1_tx_proto_enumTypes[1]
}
...
type MsgFinishInference struct {
	...
	Reason        FinishReason           `protobuf:"varint,8,opt,name=reason,proto3,enum=devshard.v1.FinishReason" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MsgFinishInference) GetReason() FinishReason {
	if x != nil {
		return x.Reason
	}
...
const file_devshard_v1_tx_proto_rawDesc = "" +
	...
	"\fconfirmed_at\x18\x03 \x01(\x03R\vconfirmedAt\"\xbc\x02\n" +
	...
	"\tescrow_id\x18\a \x01(\tR\bescrowId\x121\n" +
	"\x06reason\x18\b \x01(\x0e2\x19.devshard.v1.FinishReasonR\x06reason\"\x9c\x01\n" +
	...
	"\x18TIMEOUT_REASON_EXECUTION\x10\x02*\xbc\x01\n" +
	"\fFinishReason\x12\x1d\n" +
	"\x19FINISH_REASON_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17FINISH_REASON_COMPLETED\x10\x01\x12,\n" +
	"(FINISH_REASON_DEVSHARD_REQUESTS_DISABLED\x10\x02\x12\x1d\n" +
	"\x19FINISH_REASON_POC_ABORTED\x10\x03\x12#\n" +
	"\x1fFINISH_REASON_NO_PRESERVE_NODES\x10\x04B\x10Z\x0edevshard/typesb\x06proto3"
...
var file_devshard_v1_tx_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_devshard_v1_tx_proto_goTypes = []any{
	...
	(FinishReason)(0),           // 1: devshard.v1.FinishReason
	(*MsgStartInference)(nil),   // 2: devshard.v1.MsgStartInference
	(*MsgConfirmStart)(nil),     // 3: devshard.v1.MsgConfirmStart
	(*MsgFinishInference)(nil),  // 4: devshard.v1.MsgFinishInference
	(*MsgTimeoutInference)(nil), // 5: devshard.v1.MsgTimeoutInference
	(*TimeoutVote)(nil),         // 6: devshard.v1.TimeoutVote
	(*MsgValidation)(nil),       // 7: devshard.v1.MsgValidation
	(*MsgValidationVote)(nil),   // 8: devshard.v1.MsgValidationVote
	(*MsgRevealSeed)(nil),       // 9: devshard.v1.MsgRevealSeed
	(*MsgFinalizeRound)(nil),    // 10: devshard.v1.MsgFinalizeRound
}
var file_devshard_v1_tx_proto_depIdxs = []int32{
	1, // 0: devshard.v1.MsgFinishInference.reason:type_name -> devshard.v1.FinishReason
	0, // 1: devshard.v1.MsgTimeoutInference.reason:type_name -> devshard.v1.TimeoutReason
	6, // 2: devshard.v1.MsgTimeoutInference.votes:type_name -> devshard.v1.TimeoutVote
