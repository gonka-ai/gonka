...
type InferenceRecordProto struct {
	...
	FinishReason  uint32                 `protobuf:"varint,18,opt,name=finish_reason,json=finishReason,proto3" json:"finish_reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InferenceRecordProto) GetFinishReason() uint32 {
	if x != nil {
...
const file_devshard_v1_state_proto_rawDesc = "" +
	...
	"\aentries\x18\x01 \x03(\v2\x1b.devshard.v1.HostStatsProtoR\aentries\"\xf2\x04\n" +
	...
	"\rfinish_reason\x18\x12 \x01(\rR\ffinishReason\"Q\n" +
