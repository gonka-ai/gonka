...
func TestLocalOracleSource_ParityWithBlockOracle(t *testing.T) {
	or := &fakeOracle{hdr: &blockoracle.Header{Height: 42, ChainID: "gonka", BlockHash: []byte{0x01}}}
	...
	stale := &fakeStaleOracle{
		fakeOracle: fakeOracle{hdr: &blockoracle.Header{Height: 42, ChainID: "gonka", BlockHash: []byte{0x01}}},
		stale:      true,
	}
