...
const hsAnchorE2EEscrowID = "e2e-hs-anchor-1"
...
func (o *staticOracle) Latest(ctx context.Context) (*blockoracle.Header, error) {
	_ = ctx
	h := *o.hdr
...
func (o *staticOracle) At(ctx context.Context, height int64) (*blockoracle.Header, error) {
	_ = ctx
...
func (o *staticOracle) Prove(context.Context, string, int64) (*blockoracle.Proof, error) {
	return nil, errors.New("not implemented")
}

func (o *staticOracle) Subscribe(context.Context, int64) (<-chan *blockoracle.Header, error) {
...
func newSharedStoppingOracle(height int64, hash []byte) *sharedStoppingOracle {
	return &sharedStoppingOracle{hdr: &blockoracle.Header{
		Height:    height,
...
func (o *sharedStoppingOracle) Latest(ctx context.Context) (*blockoracle.Header, error) {
	_ = ctx
	o.mu.Lock()
	defer o.mu.Unlock()
	if o.stopped {
...
func (o *sharedStoppingOracle) At(ctx context.Context, height int64) (*blockoracle.Header, error) {
	_ = ctx
	o.mu.Lock()
	defer o.mu.Unlock()
	if o.stopped {
...
func (o *sharedStoppingOracle) Prove(context.Context, string, int64) (*blockoracle.Proof, error) {
	return nil, errors.New("not implemented")
}

func (o *sharedStoppingOracle) Subscribe(context.Context, int64) (<-chan *blockoracle.Header, error) {
	ch := make(chan *blockoracle.Header)
	close(ch)
	return ch, nil
}
...
func staticOracleWith(height int64, hash []byte) *staticOracle {
	return &staticOracle{hdr: &blockoracle.Header{
		Height:    height,
		ChainID:   "gonka-testenv-1",
		BlockHash: append([]byte(nil), hash...),
	}}
...
// setupFourHostHTTPHeightSyncFromBlockOracles builds the standard four-host httptest stack.
...
func setupFourHostHTTPHeightSyncFromBlockOracles(t *testing.T, hostSchedOracle, hostLogOracle []blockoracle.BlockOracle, clientOracle, clientLogOracle blockoracle.BlockOracle, stackMeta *staticOracle, tweak ...func(*transport.ClientConfig)) *fourHostStack {
	t.Helper()
	...
	for i := range hostSigners {
		sm, err := state.NewStateMachine(hsAnchorE2EEscrowID, cfg, group, 100_000, userSigner.Address(), verifier, state.WithWarmKeyResolver(warmResolve))
...
func setupFourHostHTTPHeightSyncWithOracles(t *testing.T, hostOracles []*staticOracle, clientOracle *staticOracle, tweak ...func(*transport.ClientConfig)) *fourHostStack {
	...
	require.NotNil(t, clientOracle)
	hsched := make([]blockoracle.BlockOracle, 4)
	hlog := make([]blockoracle.BlockOracle, 4)
	...
	return setupFourHostHTTPHeightSyncFromBlockOracles(t, hsched, hlog, clientOracle, clientOracle, clientOracle, tweak...)
}
...
func setupFourHostHTTPHeightSyncStoppingOracle(t *testing.T) (*fourHostStack, *sharedStoppingOracle) {
	...
	h := []blockoracle.BlockOracle{shared, shared, shared, shared}
	st := setupFourHostHTTPHeightSyncFromBlockOracles(t, h, h, shared, shared, nil)
	return st, shared
}
...
func (o *toggleableOracle) Latest(ctx context.Context) (*blockoracle.Header, error) {
	_ = ctx
	o.mu.Lock()
	defer o.mu.Unlock()
	if o.failNext {
...
func (o *toggleableOracle) At(ctx context.Context, height int64) (*blockoracle.Header, error) {
	_ = ctx
	o.mu.Lock()
	defer o.mu.Unlock()
	if o.hdr != nil && height == o.hdr.Height {
...
func (o *toggleableOracle) Prove(context.Context, string, int64) (*blockoracle.Proof, error) {
	return nil, errors.New("not implemented")
}

func (o *toggleableOracle) Subscribe(context.Context, int64) (<-chan *blockoracle.Header, error) {
	ch := make(chan *blockoracle.Header)
	close(ch)
	return ch, nil
}
...
func setupFourHostHTTPHeightSyncToggleableUserOracle(t *testing.T) (*fourHostStack, *toggleableOracle) {
	...
	clientOracle := &toggleableOracle{hdr: &blockoracle.Header{
...
func TestHeightSyncAnchor_E2E_LostFirstResponseSelfHealing(t *testing.T) {
	...
	_, err = st.Session.SendOnly(ctx, p1)
