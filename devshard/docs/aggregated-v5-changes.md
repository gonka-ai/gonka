...
| Knob                        | Default                                | Job                                                                                                                                                             |
| --------------------------- | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Interval                    | 6s (shipped; original landing used 3s) | Longest gap between full turnovers                                                                                                                              |
| TurnTimeout                 | 12s (2 × Interval)                     | Patience on one open turn; one dead slot cannot silence the cadence                                                                                             |
| IdleTimeout (`T_idle`)      | 24s (4 × Interval)                     | Host silence budget before arming                                                                                                                               |
