...
class KubernetesTests : TestermintTest() {
    @Test
    fun initKubernetes() {
        val k8sPairs = getK8sInferencePairs(inferenceConfig)
...
//        }
    ...
    fun k8sUpgrade() {
        ...
        val upgradeBlock = height + govParams.params.votingPeriod.toSeconds()/5 + 150 // the 50 ensures we aren't on an Epoch boundary
