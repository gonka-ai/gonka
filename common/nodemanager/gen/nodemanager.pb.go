...
type AcquireMLNodeRequest struct {
	...
	// Optional client session id, supplied by the devshard gateway in the inference
	// request payload (not an HTTP header). When set, the broker prefers this
	// session's last mlnode for KV-cache reuse.
